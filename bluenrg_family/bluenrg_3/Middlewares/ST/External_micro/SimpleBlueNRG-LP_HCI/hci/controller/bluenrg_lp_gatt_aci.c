                                                 ...
                                                 Handle_Entry_t Handle_Entry[])
{
  ...
  /* var_len_data input */
  {
    for (int i = 0; i < Number_of_Handles; i++) {
      packed_Handle_Entry_t *Handle_Entry_tmp = (packed_Handle_Entry_t *)(((uint8_t *)cmd_buffer) + index_input);
      Handle_Entry_tmp->Handle = Handle_Entry[i].Handle;
      index_input += 2;
    }
  }
  Osal_MemSet(&rq, 0, sizeof(rq));
                                     ...
                                     Gatt_Srv_Notify_Attr_t Gatt_Srv_Notify_Attr[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_srv_multi_notify_cp0 *cp0 = (aci_gatt_srv_multi_notify_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
  cp0->Flags = htob(Flags, 1);
  index_input += 1;
  cp0->Num_Of_Attr = htob(Num_Of_Attr, 1);
  index_input += 1;
  /* var_len_data input */
  {
    for (int i = 0; i < Num_Of_Attr; i++) {
      packed_Gatt_Srv_Notify_Attr_t *Gatt_Srv_Notify_Attr_tmp = (packed_Gatt_Srv_Notify_Attr_t *)(((uint8_t *)cmd_buffer) + index_input);
      Gatt_Srv_Notify_Attr_tmp->Handle = Gatt_Srv_Notify_Attr[i].Handle;
      index_input += 2;
      Gatt_Srv_Notify_Attr_tmp->Val_Length = Gatt_Srv_Notify_Attr[i].Val_Length;
      index_input += 2;
      Osal_MemCpy(Gatt_Srv_Notify_Attr_tmp->Val, Gatt_Srv_Notify_Attr[i].Val, Gatt_Srv_Notify_Attr[i].Val_Length);
      index_input += Gatt_Srv_Notify_Attr[i].Val_Length;
    }
  }
  Osal_MemSet(&rq, 0, sizeof(rq));
  rq.ext_aci = TRUE;
                                                         ...
                                                         Handle_Entry_t Handle_Entry[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_clt_read_multiple_var_len_char_value_cp0 *cp0 = (aci_gatt_clt_read_multiple_var_len_char_value_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                               ...
                                               uint8_t Attribute_Val[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_prepare_write_req_cp0 *cp0 = (aci_gatt_eatt_clt_prepare_write_req_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                               ...
                                               uint8_t Execute)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_execute_write_req_cp0 *cp0 = (aci_gatt_eatt_clt_execute_write_req_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                       ...
                                                       uint16_t CID)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_disc_all_primary_services_cp0 *cp0 = (aci_gatt_eatt_clt_disc_all_primary_services_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                          ...
                                                          UUID_t *UUID)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_disc_primary_service_by_uuid_cp0 *cp0 = (aci_gatt_eatt_clt_disc_primary_service_by_uuid_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                    ...
                                                    uint16_t End_Handle)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_find_included_services_cp0 *cp0 = (aci_gatt_eatt_clt_find_included_services_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                      ...
                                                      uint16_t End_Handle)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_disc_all_char_of_service_cp0 *cp0 = (aci_gatt_eatt_clt_disc_all_char_of_service_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                               ...
                                               UUID_t *UUID)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_disc_char_by_uuid_cp0 *cp0 = (aci_gatt_eatt_clt_disc_char_by_uuid_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                ...
                                                uint16_t End_Handle)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_disc_all_char_desc_cp0 *cp0 = (aci_gatt_eatt_clt_disc_all_char_desc_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                  ...
                                  uint16_t Attr_Handle)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_read_cp0 *cp0 = (aci_gatt_eatt_clt_read_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                  ...
                                                  UUID_t *UUID)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_read_using_char_uuid_cp0 *cp0 = (aci_gatt_eatt_clt_read_using_char_uuid_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                       ...
                                       uint16_t Val_Offset)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_read_long_cp0 *cp0 = (aci_gatt_eatt_clt_read_long_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                      ...
                                                      Handle_Entry_t Handle_Entry[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_read_multiple_char_value_cp0 *cp0 = (aci_gatt_eatt_clt_read_multiple_char_value_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                       ...
                                       uint8_t Attribute_Val[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_write_nwk_cp0 *cp0 = (aci_gatt_eatt_clt_write_nwk_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                            ...
                                            uint8_t Attribute_Val[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_write_long_nwk_cp0 *cp0 = (aci_gatt_eatt_clt_write_long_nwk_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                     ...
                                                     uint8_t Attribute_Val[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_write_char_reliable_nwk_cp0 *cp0 = (aci_gatt_eatt_clt_write_char_reliable_nwk_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                ...
                                                uint8_t Attribute_Val[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_write_without_resp_cp0 *cp0 = (aci_gatt_eatt_clt_write_without_resp_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                ...
                                                uint16_t CID)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_confirm_indication_cp0 *cp0 = (aci_gatt_eatt_clt_confirm_indication_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                    ...
                                    uint8_t Val[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_srv_notify_cp0 *cp0 = (aci_gatt_eatt_srv_notify_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                 ...
                                                 uint8_t Exec)
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_srv_exec_write_resp_nwk_cp0 *cp0 = (aci_gatt_eatt_srv_exec_write_resp_nwk_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Conn_Handle = htob(Conn_Handle, 2);
  index_input += 2;
                                                ...
                                                uint8_t Data[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_srv_authorize_resp_nwk_cp0 *cp0 = (aci_gatt_eatt_srv_authorize_resp_nwk_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Conn_Handle = htob(Conn_Handle, 2);
  index_input += 2;
                                          ...
                                          Gatt_Srv_Notify_Attr_t Gatt_Srv_Notify_Attr[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_srv_multi_notify_cp0 *cp0 = (aci_gatt_eatt_srv_multi_notify_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                                              ...
                                                              Handle_Entry_t Handle_Entry[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[532];
  aci_gatt_eatt_clt_read_multiple_var_len_char_value_cp0 *cp0 = (aci_gatt_eatt_clt_read_multiple_var_len_char_value_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;

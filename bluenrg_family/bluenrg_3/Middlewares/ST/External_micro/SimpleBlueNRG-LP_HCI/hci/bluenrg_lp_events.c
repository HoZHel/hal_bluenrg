...
tBleStatus aci_l2cap_cos_connection_event_process(uint8_t *buffer_in);
tBleStatus aci_l2cap_ecfc_reconfiguration_event_process(uint8_t *buffer_in);
...
tBleStatus aci_gatt_eatt_srv_attribute_modified_event_process(uint8_t *buffer_in);
tBleStatus aci_gatt_eatt_proc_timeout_event_process(uint8_t *buffer_in);
tBleStatus aci_eatt_clt_find_info_resp_event_process(uint8_t *buffer_in);
tBleStatus aci_eatt_clt_find_by_type_value_resp_event_process(uint8_t *buffer_in);
tBleStatus aci_eatt_clt_read_by_type_resp_event_process(uint8_t *buffer_in);
tBleStatus aci_eatt_clt_read_resp_event_process(uint8_t *buffer_in);
tBleStatus aci_eatt_clt_read_blob_resp_event_process(uint8_t *buffer_in);
tBleStatus aci_eatt_clt_read_multiple_resp_event_process(uint8_t *buffer_in);
tBleStatus aci_eatt_clt_read_by_group_type_resp_event_process(uint8_t *buffer_in);
tBleStatus aci_eatt_clt_prepare_write_resp_event_process(uint8_t *buffer_in);
tBleStatus aci_eatt_clt_exec_write_resp_event_process(uint8_t *buffer_in);
tBleStatus aci_gatt_eatt_clt_indication_event_process(uint8_t *buffer_in);
tBleStatus aci_gatt_eatt_clt_notification_event_process(uint8_t *buffer_in);
tBleStatus aci_gatt_eatt_clt_proc_complete_event_process(uint8_t *buffer_in);
tBleStatus aci_gatt_eatt_clt_error_resp_event_process(uint8_t *buffer_in);
tBleStatus aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event_process(uint8_t *buffer_in);
tBleStatus aci_gatt_eatt_srv_confirmation_event_process(uint8_t *buffer_in);
tBleStatus aci_eatt_srv_exec_write_req_event_process(uint8_t *buffer_in);
tBleStatus aci_gatt_eatt_srv_authorize_nwk_event_process(uint8_t *buffer_in);
tBleStatus aci_eatt_clt_read_multiple_var_len_resp_event_process(uint8_t *buffer_in);
...
const hci_le_meta_events_table_type hci_le_meta_events_table[34] = {
  ...
  0x0019, hci_le_cis_established_event_process,
  /* hci_le_cis_request_event */
  0x001a, hci_le_cis_request_event_process,
  /* hci_le_create_big_complete_event */
  0x001b, hci_le_create_big_complete_event_process,
  /* hci_le_terminate_big_complete_event */
  0x001c, hci_le_terminate_big_complete_event_process,
  /* hci_le_big_sync_established_event */
  0x001d, hci_le_big_sync_established_event_process,
  /* hci_le_big_sync_lost_event */
  0x001e, hci_le_big_sync_lost_event_process,
  /* hci_le_request_peer_sca_complete_event */
  0x001f, hci_le_request_peer_sca_complete_event_process,
  ...
  0x0022, hci_le_biginfo_advertising_report_event_process,
  /* hci_le_subrate_change_event */
  0x0023, hci_le_subrate_change_event_process,
};
const hci_vendor_specific_events_table_type hci_vendor_specific_events_table[67] = {
  ...
  0x0808, aci_l2cap_cos_connection_event_process,
  /* aci_l2cap_ecfc_reconfiguration_event */
  0x0809, aci_l2cap_ecfc_reconfiguration_event_process,
  ...
  0x0c1e, aci_att_clt_read_multiple_var_len_resp_event_process,
  /* aci_gatt_eatt_srv_attribute_modified_event */
  0x0c22, aci_gatt_eatt_srv_attribute_modified_event_process,
  /* aci_gatt_eatt_proc_timeout_event */
  0x0c23, aci_gatt_eatt_proc_timeout_event_process,
  /* aci_eatt_clt_find_info_resp_event */
  0x0c24, aci_eatt_clt_find_info_resp_event_process,
  /* aci_eatt_clt_find_by_type_value_resp_event */
  0x0c25, aci_eatt_clt_find_by_type_value_resp_event_process,
  /* aci_eatt_clt_read_by_type_resp_event */
  0x0c26, aci_eatt_clt_read_by_type_resp_event_process,
  /* aci_eatt_clt_read_resp_event */
  0x0c27, aci_eatt_clt_read_resp_event_process,
  /* aci_eatt_clt_read_blob_resp_event */
  0x0c28, aci_eatt_clt_read_blob_resp_event_process,
  /* aci_eatt_clt_read_multiple_resp_event */
  0x0c29, aci_eatt_clt_read_multiple_resp_event_process,
  /* aci_eatt_clt_read_by_group_type_resp_event */
  0x0c2a, aci_eatt_clt_read_by_group_type_resp_event_process,
  /* aci_eatt_clt_prepare_write_resp_event */
  0x0c2b, aci_eatt_clt_prepare_write_resp_event_process,
  /* aci_eatt_clt_exec_write_resp_event */
  0x0c2c, aci_eatt_clt_exec_write_resp_event_process,
  /* aci_gatt_eatt_clt_indication_event */
  0x0c2d, aci_gatt_eatt_clt_indication_event_process,
  /* aci_gatt_eatt_clt_notification_event */
  0x0c2e, aci_gatt_eatt_clt_notification_event_process,
  /* aci_gatt_eatt_clt_proc_complete_event */
  0x0c2f, aci_gatt_eatt_clt_proc_complete_event_process,
  /* aci_gatt_eatt_clt_error_resp_event */
  0x0c30, aci_gatt_eatt_clt_error_resp_event_process,
  /* aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event */
  0x0c31, aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event_process,
  /* aci_gatt_eatt_srv_confirmation_event */
  0x0c32, aci_gatt_eatt_srv_confirmation_event_process,
  /* aci_eatt_srv_exec_write_req_event */
  0x0c33, aci_eatt_srv_exec_write_req_event_process,
  /* aci_gatt_eatt_srv_authorize_nwk_event */
  0x0c34, aci_gatt_eatt_srv_authorize_nwk_event_process,
  /* aci_eatt_clt_read_multiple_var_len_resp_event */
  0x0c35, aci_eatt_clt_read_multiple_var_len_resp_event_process,
};
/* hci_disconnection_complete_event */
/* Event len: 1 + 2 + 1 */
/**
...
tBleStatus aci_l2cap_cos_connection_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_l2cap_cos_connection_event_rp0 *rp0 = (aci_l2cap_cos_connection_event_rp0 *)buffer_in;
  uint8_t size = 15;
  int i;
  conn_cid_t conn_cid[HCI_MAX_PAYLOAD_SIZE/sizeof(conn_cid_t)];
  for (i = 0; i < rp0->CID_Count; i++) {
    conn_cid[i].Local_CID = rp0->conn_cid[i].Local_CID;
    size += 2;
    conn_cid[i].Remote_CID = rp0->conn_cid[i].Remote_CID;
    size += 2;
  }
  aci_l2cap_cos_connection_event(rp0->Connection_Handle,
                                 rp0->Event_Type,
                                 rp0->Identifier,
                                 rp0->SPSM,
                                 rp0->Peer_MTU,
...
tBleStatus aci_l2cap_ecfc_reconfiguration_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_l2cap_ecfc_reconfiguration_event_rp0 *rp0 = (aci_l2cap_ecfc_reconfiguration_event_rp0 *)buffer_in;
  uint8_t size = 11;
  int i;
  local_reconf_cid_t local_reconf_cid[HCI_MAX_PAYLOAD_SIZE/sizeof(local_reconf_cid_t)];
  for (i = 0; i < rp0->CID_Count; i++) {
    local_reconf_cid[i].Local_CID = rp0->local_reconf_cid[i].Local_CID;
    size += 2;
  }
  aci_l2cap_ecfc_reconfiguration_event(rp0->Connection_Handle,
                                       rp0->Event_Type,
                                       rp0->Result,
                                       rp0->Identifier,
                                       rp0->Peer_MTU,
...
tBleStatus aci_gatt_eatt_srv_attribute_modified_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_gatt_eatt_srv_attribute_modified_event_rp0 *rp0 = (aci_gatt_eatt_srv_attribute_modified_event_rp0 *)buffer_in;
  aci_gatt_eatt_srv_attribute_modified_event(rp0->Connection_Handle,
                                             rp0->CID,
                                             rp0->Attr_Handle,
                                             rp0->Attr_Data_Length,
                                             rp0->Attr_Data);
...
tBleStatus aci_gatt_eatt_proc_timeout_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_gatt_eatt_proc_timeout_event_rp0 *rp0 = (aci_gatt_eatt_proc_timeout_event_rp0 *)buffer_in;
  aci_gatt_eatt_proc_timeout_event(rp0->Connection_Handle,
                                   rp0->CID);
...
tBleStatus aci_eatt_clt_find_info_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_eatt_clt_find_info_resp_event_rp0 *rp0 = (aci_eatt_clt_find_info_resp_event_rp0 *)buffer_in;
  aci_eatt_clt_find_info_resp_event(rp0->Connection_Handle,
                                    rp0->CID,
                                    rp0->Format,
                                    rp0->Event_Data_Length,
                                    rp0->Handle_UUID_Pair);
...
tBleStatus aci_eatt_clt_find_by_type_value_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_eatt_clt_find_by_type_value_resp_event_rp0 *rp0 = (aci_eatt_clt_find_by_type_value_resp_event_rp0 *)buffer_in;
  uint8_t size = 5;
  int i;
  Attribute_Group_Handle_Pair_t Attribute_Group_Handle_Pair[HCI_MAX_PAYLOAD_SIZE/sizeof(Attribute_Group_Handle_Pair_t)];
  for (i = 0; i < rp0->Num_of_Handle_Pair; i++) {
  ...
  aci_eatt_clt_find_by_type_value_resp_event(rp0->Connection_Handle,
                                             rp0->CID,
                                             rp0->Num_of_Handle_Pair,
                                             Attribute_Group_Handle_Pair);
...
tBleStatus aci_eatt_clt_read_by_type_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_eatt_clt_read_by_type_resp_event_rp0 *rp0 = (aci_eatt_clt_read_by_type_resp_event_rp0 *)buffer_in;
  aci_eatt_clt_read_by_type_resp_event(rp0->Connection_Handle,
                                       rp0->CID,
                                       rp0->Handle_Value_Pair_Length,
                                       rp0->Data_Length,
                                       rp0->Handle_Value_Pair_Data);
...
tBleStatus aci_eatt_clt_read_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_eatt_clt_read_resp_event_rp0 *rp0 = (aci_eatt_clt_read_resp_event_rp0 *)buffer_in;
  aci_eatt_clt_read_resp_event(rp0->Connection_Handle,
                               rp0->CID,
                               rp0->Event_Data_Length,
                               rp0->Attribute_Value);
...
tBleStatus aci_eatt_clt_read_blob_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_eatt_clt_read_blob_resp_event_rp0 *rp0 = (aci_eatt_clt_read_blob_resp_event_rp0 *)buffer_in;
  aci_eatt_clt_read_blob_resp_event(rp0->Connection_Handle,
                                    rp0->CID,
                                    rp0->Event_Data_Length,
                                    rp0->Attribute_Value);
...
tBleStatus aci_eatt_clt_read_multiple_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_eatt_clt_read_multiple_resp_event_rp0 *rp0 = (aci_eatt_clt_read_multiple_resp_event_rp0 *)buffer_in;
  aci_eatt_clt_read_multiple_resp_event(rp0->Connection_Handle,
                                        rp0->CID,
                                        rp0->Event_Data_Length,
                                        rp0->Set_Of_Values);
...
tBleStatus aci_eatt_clt_read_by_group_type_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_eatt_clt_read_by_group_type_resp_event_rp0 *rp0 = (aci_eatt_clt_read_by_group_type_resp_event_rp0 *)buffer_in;
  aci_eatt_clt_read_by_group_type_resp_event(rp0->Connection_Handle,
                                             rp0->CID,
                                             rp0->Attribute_Data_Length,
                                             rp0->Data_Length,
                                             rp0->Attribute_Data_List);
...
tBleStatus aci_eatt_clt_prepare_write_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_eatt_clt_prepare_write_resp_event_rp0 *rp0 = (aci_eatt_clt_prepare_write_resp_event_rp0 *)buffer_in;
  aci_eatt_clt_prepare_write_resp_event(rp0->Connection_Handle,
                                        rp0->CID,
                                        rp0->Attribute_Handle,
                                        rp0->Offset,
                                        rp0->Part_Attribute_Value_Length,
...
tBleStatus aci_eatt_clt_exec_write_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_eatt_clt_exec_write_resp_event_rp0 *rp0 = (aci_eatt_clt_exec_write_resp_event_rp0 *)buffer_in;
  aci_eatt_clt_exec_write_resp_event(rp0->Connection_Handle,
                                     rp0->CID);
...
tBleStatus aci_gatt_eatt_clt_indication_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_gatt_eatt_clt_indication_event_rp0 *rp0 = (aci_gatt_eatt_clt_indication_event_rp0 *)buffer_in;
  aci_gatt_eatt_clt_indication_event(rp0->Connection_Handle,
                                     rp0->CID,
                                     rp0->Attribute_Handle,
                                     rp0->Attribute_Value_Length,
                                     rp0->Attribute_Value);
...
tBleStatus aci_gatt_eatt_clt_notification_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_gatt_eatt_clt_notification_event_rp0 *rp0 = (aci_gatt_eatt_clt_notification_event_rp0 *)buffer_in;
  aci_gatt_eatt_clt_notification_event(rp0->Connection_Handle,
                                       rp0->CID,
                                       rp0->Attribute_Handle,
                                       rp0->Attribute_Value_Length,
                                       rp0->Attribute_Value);
...
tBleStatus aci_gatt_eatt_clt_proc_complete_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_gatt_eatt_clt_proc_complete_event_rp0 *rp0 = (aci_gatt_eatt_clt_proc_complete_event_rp0 *)buffer_in;
  aci_gatt_eatt_clt_proc_complete_event(rp0->Connection_Handle,
                                        rp0->CID,
                                        rp0->Error_Code);
...
tBleStatus aci_gatt_eatt_clt_error_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_gatt_eatt_clt_error_resp_event_rp0 *rp0 = (aci_gatt_eatt_clt_error_resp_event_rp0 *)buffer_in;
  aci_gatt_eatt_clt_error_resp_event(rp0->Connection_Handle,
                                     rp0->CID,
                                     rp0->Req_Opcode,
                                     rp0->Attribute_Handle,
                                     rp0->Error_Code);
...
tBleStatus aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event_rp0 *rp0 = (aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event_rp0 *)buffer_in;
  aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event(rp0->Connection_Handle,
                                                      rp0->CID,
                                                      rp0->Attribute_Handle,
                                                      rp0->Attribute_Value_Length,
                                                      rp0->Attribute_Value);
...
tBleStatus aci_gatt_eatt_srv_confirmation_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_gatt_eatt_srv_confirmation_event_rp0 *rp0 = (aci_gatt_eatt_srv_confirmation_event_rp0 *)buffer_in;
  aci_gatt_eatt_srv_confirmation_event(rp0->Connection_Handle,
                                       rp0->CID);
...
tBleStatus aci_eatt_srv_exec_write_req_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_eatt_srv_exec_write_req_event_rp0 *rp0 = (aci_eatt_srv_exec_write_req_event_rp0 *)buffer_in;
  aci_eatt_srv_exec_write_req_event(rp0->Connection_Handle,
                                    rp0->CID,
                                    rp0->Flags);
...
tBleStatus aci_gatt_eatt_srv_authorize_nwk_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_gatt_eatt_srv_authorize_nwk_event_rp0 *rp0 = (aci_gatt_eatt_srv_authorize_nwk_event_rp0 *)buffer_in;
  aci_gatt_eatt_srv_authorize_nwk_event(rp0->Conn_Handle,
                                        rp0->CID,
                                        rp0->Attr_Handle,
                                        rp0->Operation_Type,
                                        rp0->Attr_Val_Offset,
...
tBleStatus aci_eatt_clt_read_multiple_var_len_resp_event_process(uint8_t *buffer_in)
{
  tBleStatus status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_eatt_clt_read_multiple_var_len_resp_event_rp0 *rp0 = (aci_eatt_clt_read_multiple_var_len_resp_event_rp0 *)buffer_in;
  aci_eatt_clt_read_multiple_var_len_resp_event(rp0->Connection_Handle,
                                                rp0->CID,
                                                rp0->Event_Data_Length,
                                                rp0->Set_Of_Values);
...
tBleStatus hci_le_extended_advertising_report_event_process(uint8_t *buffer_in)
{
  ...
  for (i = 0; i < rp0->Num_Reports; i++) {
    ...
    size += 1;
    Osal_MemCpy((void *) Extended_Advertising_Report[i].Address, (const void *) rp0->Extended_Advertising_Report[i].Address, 6);
    size += 6;
    ...
    size += 1;
    Osal_MemCpy((void *) Extended_Advertising_Report[i].Direct_Address, (const void *) rp0->Extended_Advertising_Report[i].Direct_Address, 6);
    size += 6;
...
tBleStatus hci_le_create_big_complete_event_process(uint8_t *buffer_in)
{
  ...
  uint8_t size = 18;
  int i;
  Connection_Handle_t Connection_Handle[HCI_MAX_PAYLOAD_SIZE/sizeof(Connection_Handle_t)];
  for (i = 0; i < rp0->Num_BIS; i++) {
    Connection_Handle[i].Connection_Handle = rp0->Connection_Handle[i].Connection_Handle;
    size += 2;
  }

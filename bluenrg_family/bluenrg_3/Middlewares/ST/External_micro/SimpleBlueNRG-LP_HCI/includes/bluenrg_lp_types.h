...
extern const hci_le_meta_events_table_type hci_le_meta_events_table[34];
extern const hci_vendor_specific_events_table_type hci_vendor_specific_events_table[67];
#include <stdint.h>

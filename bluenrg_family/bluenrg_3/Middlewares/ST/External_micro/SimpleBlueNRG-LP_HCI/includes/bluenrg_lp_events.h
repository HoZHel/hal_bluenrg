 ...
 * @retval None
 */
WEAK_FUNCTION(void hci_le_cis_established_event(uint8_t Status,
                                  uint16_t Connection_Handle,
 ...
 * @retval None
 */
WEAK_FUNCTION(void hci_le_create_big_complete_event(uint8_t Status,
                                      uint8_t BIG_Handle,
 ...
 * @retval None
 */
WEAK_FUNCTION(void hci_le_big_sync_established_event(uint8_t Status,
                                       uint8_t BIG_Handle,
                                       uint8_t Transport_Latency_BIG[3],
                                       uint8_t NSE,
                                       uint8_t BN,
 ...
 * @retval None
 */
WEAK_FUNCTION(void hci_le_biginfo_advertising_report_event(uint16_t Sync_Handle,
                                             uint8_t Num_BIS,
                                             uint8_t NSE,
                                             uint16_t ISO_Interval,
                                             uint8_t BN,
 ...
 * @retval None
 */
WEAK_FUNCTION(void hci_le_subrate_change_event(uint8_t Status,
                                 uint16_t Connection_Handle,
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_gatt_srv_authorize_nwk_event(uint16_t Conn_Handle,
                                      uint16_t Attr_Handle,
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_gatt_eatt_srv_attribute_modified_event(uint16_t Connection_Handle,
                                                uint16_t CID,
                                                uint16_t Attr_Handle,
                                                uint16_t Attr_Data_Length,
                                                uint8_t Attr_Data[]));
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_gatt_eatt_proc_timeout_event(uint16_t Connection_Handle,
                                      uint16_t CID));
/**
 * @brief This event is generated in response to a Find Information Request
 *        during a discovery procedure for all the characteristic descriptors.
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_eatt_clt_find_info_resp_event(uint16_t Connection_Handle,
                                       uint16_t CID,
                                       uint8_t Format,
                                       uint16_t Event_Data_Length,
                                       uint8_t Handle_UUID_Pair[]));
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_eatt_clt_find_by_type_value_resp_event(uint16_t Connection_Handle,
                                                uint16_t CID,
                                                uint8_t Num_of_Handle_Pair,
                                                Attribute_Group_Handle_Pair_t Attribute_Group_Handle_Pair[]));
/**
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_eatt_clt_read_by_type_resp_event(uint16_t Connection_Handle,
                                          uint16_t CID,
                                          uint8_t Handle_Value_Pair_Length,
                                          uint16_t Data_Length,
                                          uint8_t Handle_Value_Pair_Data[]));
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_eatt_clt_read_resp_event(uint16_t Connection_Handle,
                                  uint16_t CID,
                                  uint16_t Event_Data_Length,
                                  uint8_t Attribute_Value[]));
/**
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_eatt_clt_read_blob_resp_event(uint16_t Connection_Handle,
                                       uint16_t CID,
                                       uint16_t Event_Data_Length,
                                       uint8_t Attribute_Value[]));
/**
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_eatt_clt_read_multiple_resp_event(uint16_t Connection_Handle,
                                           uint16_t CID,
                                           uint16_t Event_Data_Length,
                                           uint8_t Set_Of_Values[]));
/**
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_eatt_clt_read_by_group_type_resp_event(uint16_t Connection_Handle,
                                                uint16_t CID,
                                                uint8_t Attribute_Data_Length,
                                                uint16_t Data_Length,
                                                uint8_t Attribute_Data_List[]));
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_eatt_clt_prepare_write_resp_event(uint16_t Connection_Handle,
                                           uint16_t CID,
                                           uint16_t Attribute_Handle,
                                           uint16_t Offset,
                                           uint16_t Part_Attribute_Value_Length,
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_eatt_clt_exec_write_resp_event(uint16_t Connection_Handle,
                                        uint16_t CID));
/**
 * @brief This event is generated when an indication is received from the
 *        server.
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_gatt_eatt_clt_indication_event(uint16_t Connection_Handle,
                                        uint16_t CID,
                                        uint16_t Attribute_Handle,
                                        uint16_t Attribute_Value_Length,
                                        uint8_t Attribute_Value[]));
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_gatt_eatt_clt_notification_event(uint16_t Connection_Handle,
                                          uint16_t CID,
                                          uint16_t Attribute_Handle,
                                          uint16_t Attribute_Value_Length,
                                          uint8_t Attribute_Value[]));
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_gatt_eatt_clt_proc_complete_event(uint16_t Connection_Handle,
                                           uint16_t CID,
                                           uint8_t Error_Code));
/**
 * @brief This event is generated when an Error Response is received from the
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_gatt_eatt_clt_error_resp_event(uint16_t Connection_Handle,
                                        uint16_t CID,
                                        uint8_t Req_Opcode,
                                        uint16_t Attribute_Handle,
                                        uint8_t Error_Code));
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event(uint16_t Connection_Handle,
                                                         uint16_t CID,
                                                         uint16_t Attribute_Handle,
                                                         uint8_t Attribute_Value_Length,
                                                         uint8_t Attribute_Value[]));
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_gatt_eatt_srv_confirmation_event(uint16_t Connection_Handle,
                                          uint16_t CID));
/**
 * @brief This event is generated when an execute write request is received from
 *        the peer. This happens when the client wants to write a long attribute
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_eatt_srv_exec_write_req_event(uint16_t Connection_Handle,
                                       uint16_t CID,
                                       uint8_t Flags));
/**
 * @brief This event is generated if authorization is needed to access the
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_gatt_eatt_srv_authorize_nwk_event(uint16_t Conn_Handle,
                                           uint16_t CID,
                                           uint16_t Attr_Handle,
                                           uint8_t Operation_Type,
                                           uint16_t Attr_Val_Offset,
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_eatt_clt_read_multiple_var_len_resp_event(uint16_t Connection_Handle,
                                                   uint16_t CID,
                                                   uint16_t Event_Data_Length,
                                                   uint8_t Set_Of_Values[]));
/**
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_l2cap_cos_connection_event(uint16_t Connection_Handle,
                                    uint8_t Event_Type,
                                    uint8_t Identifier,
                                    uint16_t SPSM,
                                    uint16_t Peer_MTU,
 ...
 * @retval None
 */
WEAK_FUNCTION(void aci_l2cap_ecfc_reconfiguration_event(uint16_t Connection_Handle,
                                          uint8_t Event_Type,
                                          uint16_t Result,
                                          uint8_t Identifier,
                                          uint16_t Peer_MTU,

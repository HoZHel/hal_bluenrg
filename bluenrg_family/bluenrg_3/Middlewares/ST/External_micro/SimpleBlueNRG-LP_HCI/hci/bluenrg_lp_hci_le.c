...
{
  struct hci_request rq;
  hci_read_connection_accept_timeout_rp0 resp;
  ...
  *Connection_Accept_Timeout = btoh(resp.Connection_Accept_Timeout, 2);
  return BLE_STATUS_SUCCESS;
}
tBleStatus hci_write_connection_accept_timeout(uint16_t Connection_Accept_Timeout)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_write_connection_accept_timeout_cp0 *cp0 = (hci_write_connection_accept_timeout_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Accept_Timeout = htob(Connection_Accept_Timeout, 2);
  index_input += 2;
  Osal_MemSet(&rq, 0, sizeof(rq));
  rq.ogf = 0x03;
  rq.ocf = 0x016;
...
{
  struct hci_request rq;
  hci_read_afh_channel_assessment_mode_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  Osal_MemSet(&rq, 0, sizeof(rq));
  rq.ogf = 0x03;
  rq.ocf = 0x048;
  ...
  *AFH_Channel_Assessment_Mode = btoh(resp.AFH_Channel_Assessment_Mode, 1);
  return BLE_STATUS_SUCCESS;
}
tBleStatus hci_write_afh_channel_assessment_mode(uint8_t AFH_Channel_Assessment_Mode)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_write_afh_channel_assessment_mode_cp0 *cp0 = (hci_write_afh_channel_assessment_mode_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->AFH_Channel_Assessment_Mode = htob(AFH_Channel_Assessment_Mode, 1);
  index_input += 1;
  Osal_MemSet(&rq, 0, sizeof(rq));
  rq.ogf = 0x03;
  rq.ocf = 0x049;
                                               ...
                                               Extended_Scan_Parameters_t Extended_Scan_Parameters[])
{
  ...
  {
    for (int i = 0; i < len; i++) {
      packed_Extended_Scan_Parameters_t *Extended_Scan_Parameters_tmp = (packed_Extended_Scan_Parameters_t *)(((uint8_t *)cmd_buffer) + index_input);
      Extended_Scan_Parameters_tmp->Scan_Type = Extended_Scan_Parameters[i].Scan_Type;
      index_input += 1;
      Extended_Scan_Parameters_tmp->Scan_Interval = Extended_Scan_Parameters[i].Scan_Interval;
      index_input += 2;
      Extended_Scan_Parameters_tmp->Scan_Window = Extended_Scan_Parameters[i].Scan_Window;
      index_input += 2;
    }
  }
  Osal_MemSet(&rq, 0, sizeof(rq));
                                             ...
                                             Extended_Create_Connection_Parameters_t Extended_Create_Connection_Parameters[])
{
  ...
  {
    for (int i = 0; i < len; i++) {
      packed_Extended_Create_Connection_Parameters_t *Extended_Create_Connection_Parameters_tmp = (packed_Extended_Create_Connection_Parameters_t *)(((uint8_t *)cmd_buffer) + index_input);
      Extended_Create_Connection_Parameters_tmp->Scan_Interval = Extended_Create_Connection_Parameters[i].Scan_Interval;
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Scan_Window = Extended_Create_Connection_Parameters[i].Scan_Window;
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Conn_Interval_Min = Extended_Create_Connection_Parameters[i].Conn_Interval_Min;
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Conn_Interval_Max = Extended_Create_Connection_Parameters[i].Conn_Interval_Max;
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Conn_Latency = Extended_Create_Connection_Parameters[i].Conn_Latency;
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Supervision_Timeout = Extended_Create_Connection_Parameters[i].Supervision_Timeout;
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Minimum_CE_Length = Extended_Create_Connection_Parameters[i].Minimum_CE_Length;
      index_input += 2;
      Extended_Create_Connection_Parameters_tmp->Maximum_CE_Length = Extended_Create_Connection_Parameters[i].Maximum_CE_Length;
      index_input += 2;
    }
  }
  Osal_MemSet(&rq, 0, sizeof(rq));
...
{
  struct hci_request rq;
  hci_le_read_buffer_size_v2_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  Osal_MemSet(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x060;
  ...
  *HC_LE_ACL_Data_Packet_Length = btoh(resp.HC_LE_ACL_Data_Packet_Length, 2);
  *HC_Total_Num_LE_ACL_Data_Packets = btoh(resp.HC_Total_Num_LE_ACL_Data_Packets, 1);
  *ISO_Data_Packet_Length = btoh(resp.ISO_Data_Packet_Length, 2);
  *Total_Num_ISO_Data_Packets = btoh(resp.Total_Num_ISO_Data_Packets, 1);
  return BLE_STATUS_SUCCESS;
}
                                   ...
                                   uint8_t Time_Offset[3])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_read_iso_tx_sync_cp0 *cp0 = (hci_le_read_iso_tx_sync_cp0*)(cmd_buffer);
  hci_le_read_iso_tx_sync_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
  ...
  *Packet_Sequence_Number = btoh(resp.Packet_Sequence_Number, 2);
  *TX_Time_Stamp = btoh(resp.TX_Time_Stamp, 4);
  Osal_MemCpy((void *) Time_Offset, (const void *) resp.Time_Offset, 3);
  return BLE_STATUS_SUCCESS;
}
                                     ...
                                     CIS_Conn_Handles_t CIS_Conn_Handles[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_set_cig_parameters_cp0 *cp0 = (hci_le_set_cig_parameters_cp0*)(cmd_buffer);
  hci_le_set_cig_parameters_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->CIG_ID = htob(CIG_ID, 1);
  index_input += 1;
  Osal_MemCpy((void *) &cp0->SDU_Interval_C_To_P, (const void *) SDU_Interval_C_To_P, 3);
  index_input += 3;
  Osal_MemCpy((void *) &cp0->SDU_Interval_P_To_C, (const void *) SDU_Interval_P_To_C, 3);
  index_input += 3;
  cp0->Worst_Case_SCA = htob(Worst_Case_SCA, 1);
  index_input += 1;
  cp0->Packing = htob(Packing, 1);
  index_input += 1;
  cp0->Framing = htob(Framing, 1);
  index_input += 1;
  cp0->Max_Transport_Latency_C_To_P = htob(Max_Transport_Latency_C_To_P, 2);
  index_input += 2;
  cp0->Max_Transport_Latency_P_To_C = htob(Max_Transport_Latency_P_To_C, 2);
  index_input += 2;
  cp0->CIS_Count = htob(CIS_Count, 1);
  index_input += 1;
  /* var_len_data input */
  {
    for (int i = 0; i < CIS_Count; i++) {
      packed_CIS_Param_t *CIS_Param_tmp = (packed_CIS_Param_t *)(((uint8_t *)cmd_buffer) + index_input);
      CIS_Param_tmp->CIS_ID = CIS_Param[i].CIS_ID;
      index_input += 1;
      CIS_Param_tmp->Max_SDU_C_To_P = CIS_Param[i].Max_SDU_C_To_P;
      index_input += 2;
      CIS_Param_tmp->Max_SDU_P_To_C = CIS_Param[i].Max_SDU_P_To_C;
      index_input += 2;
      CIS_Param_tmp->PHY_C_To_P = CIS_Param[i].PHY_C_To_P;
      index_input += 1;
      CIS_Param_tmp->PHY_P_To_C = CIS_Param[i].PHY_P_To_C;
      index_input += 1;
      CIS_Param_tmp->RTN_C_To_P = CIS_Param[i].RTN_C_To_P;
      index_input += 1;
      CIS_Param_tmp->RTN_P_To_C = CIS_Param[i].RTN_P_To_C;
      index_input += 1;
    }
  }
  Osal_MemSet(&rq, 0, sizeof(rq));
  ...
  Osal_MemCpy((void *) CIS_Conn_Handles, (const void *) resp.CIS_Conn_Handles, CIS_Count*sizeof(CIS_Conn_Handles_t));
  return BLE_STATUS_SUCCESS;
}
                                          ...
                                          CIS_Conn_Handles_t CIS_Conn_Handles[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_set_cig_parameters_test_cp0 *cp0 = (hci_le_set_cig_parameters_test_cp0*)(cmd_buffer);
  hci_le_set_cig_parameters_test_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->CIG_ID = htob(CIG_ID, 1);
  index_input += 1;
  ...
  Osal_MemCpy((void *) &cp0->SDU_Interval_P_To_C, (const void *) SDU_Interval_P_To_C, 3);
  index_input += 3;
  cp0->FT_C_To_P = htob(FT_C_To_P, 1);
  index_input += 1;
  cp0->FT_P_To_C = htob(FT_P_To_C, 1);
  index_input += 1;
  cp0->ISO_Interval = htob(ISO_Interval, 2);
  index_input += 2;
  cp0->Worst_Case_SCA = htob(Worst_Case_SCA, 1);
  index_input += 1;
  cp0->Packing = htob(Packing, 1);
  ...
  {
    for (int i = 0; i < CIS_Count; i++) {
      packed_CIS_Param_Test_t *CIS_Param_Test_tmp = (packed_CIS_Param_Test_t *)(((uint8_t *)cmd_buffer) + index_input);
      CIS_Param_Test_tmp->CIS_ID = CIS_Param_Test[i].CIS_ID;
      index_input += 1;
      CIS_Param_Test_tmp->NSE = CIS_Param_Test[i].NSE;
      index_input += 1;
      CIS_Param_Test_tmp->Max_SDU_C_To_P = CIS_Param_Test[i].Max_SDU_C_To_P;
      index_input += 2;
      CIS_Param_Test_tmp->Max_SDU_P_To_C = CIS_Param_Test[i].Max_SDU_P_To_C;
      index_input += 2;
      CIS_Param_Test_tmp->Max_PDU_C_To_P = CIS_Param_Test[i].Max_PDU_C_To_P;
      index_input += 2;
      CIS_Param_Test_tmp->Max_PDU_P_To_C = CIS_Param_Test[i].Max_PDU_P_To_C;
      index_input += 2;
      CIS_Param_Test_tmp->PHY_C_To_P = CIS_Param_Test[i].PHY_C_To_P;
      index_input += 1;
      CIS_Param_Test_tmp->PHY_P_To_C = CIS_Param_Test[i].PHY_P_To_C;
      index_input += 1;
      CIS_Param_Test_tmp->BN_C_To_P = CIS_Param_Test[i].BN_C_To_P;
      index_input += 1;
      CIS_Param_Test_tmp->BN_P_To_C = CIS_Param_Test[i].BN_P_To_C;
      index_input += 1;
    }
  }
  Osal_MemSet(&rq, 0, sizeof(rq));
                             ...
                             CIS_Handles_t CIS_Handles[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_create_cis_cp0 *cp0 = (hci_le_create_cis_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->CIS_Count = htob(CIS_Count, 1);
  index_input += 1;
  ...
  {
    for (int i = 0; i < CIS_Count; i++) {
      packed_CIS_Handles_t *CIS_Handles_tmp = (packed_CIS_Handles_t *)(((uint8_t *)cmd_buffer) + index_input);
      CIS_Handles_tmp->CIS_Connection_Handle = CIS_Handles[i].CIS_Connection_Handle;
      index_input += 2;
      CIS_Handles_tmp->ACL_Connection_Handle = CIS_Handles[i].ACL_Connection_Handle;
      index_input += 2;
    }
  }
  Osal_MemSet(&rq, 0, sizeof(rq));
...
tBleStatus hci_le_remove_cig(uint8_t CIG_ID)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_remove_cig_cp0 *cp0 = (hci_le_remove_cig_cp0*)(cmd_buffer);
  hci_le_remove_cig_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->CIG_ID = htob(CIG_ID, 1);
  index_input += 1;
...
tBleStatus hci_le_accept_cis_request(uint16_t Connection_Handle)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_accept_cis_request_cp0 *cp0 = (hci_le_accept_cis_request_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                     ...
                                     uint8_t Reason)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_reject_cis_request_cp0 *cp0 = (hci_le_reject_cis_request_cp0*)(cmd_buffer);
  hci_le_reject_cis_request_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                             ...
                             uint8_t Broadcast_Code[16])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_create_big_cp0 *cp0 = (hci_le_create_big_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->BIG_Handle = htob(BIG_Handle, 1);
  index_input += 1;
  cp0->Advertising_Handle = htob(Advertising_Handle, 1);
  index_input += 1;
  cp0->Num_BIS = htob(Num_BIS, 1);
  index_input += 1;
  Osal_MemCpy((void *) &cp0->SDU_Interval, (const void *) SDU_Interval, 3);
  index_input += 3;
  cp0->Max_SDU = htob(Max_SDU, 2);
  index_input += 2;
  cp0->Max_Transport_Latency = htob(Max_Transport_Latency, 2);
  index_input += 2;
  cp0->RTN = htob(RTN, 1);
  index_input += 1;
  cp0->PHY = htob(PHY, 1);
  ...
  cp0->Framing = htob(Framing, 1);
  index_input += 1;
  cp0->Encryption = htob(Encryption, 1);
  index_input += 1;
  Osal_MemCpy((void *) &cp0->Broadcast_Code, (const void *) Broadcast_Code, 16);
  index_input += 16;
  Osal_MemSet(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x068;
                                  ...
                                  uint8_t Broadcast_Code[16])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_create_big_test_cp0 *cp0 = (hci_le_create_big_test_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->BIG_Handle = htob(BIG_Handle, 1);
  index_input += 1;
                                ...
                                uint8_t Reason)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_terminate_big_cp0 *cp0 = (hci_le_terminate_big_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->BIG_Handle = htob(BIG_Handle, 1);
  index_input += 1;
                                  ...
                                  BIS_t BIS[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_big_create_sync_cp0 *cp0 = (hci_le_big_create_sync_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->BIG_Handle = htob(BIG_Handle, 1);
  index_input += 1;
  ...
  cp0->MSE = htob(MSE, 1);
  index_input += 1;
  cp0->BIG_Sync_Timeout = htob(BIG_Sync_Timeout, 2);
  index_input += 2;
  cp0->Num_BIS = htob(Num_BIS, 1);
  index_input += 1;
  /* var_len_data input */
  {
    for (int i = 0; i < Num_BIS; i++) {
      packed_BIS_t *BIS_tmp = (packed_BIS_t *)(((uint8_t *)cmd_buffer) + index_input);
      BIS_tmp->BIS = BIS[i].BIS;
      index_input += 1;
    }
  }
  Osal_MemSet(&rq, 0, sizeof(rq));
...
tBleStatus hci_le_big_terminate_sync(uint8_t BIG_Handle)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_big_terminate_sync_cp0 *cp0 = (hci_le_big_terminate_sync_cp0*)(cmd_buffer);
  hci_le_big_terminate_sync_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->BIG_Handle = htob(BIG_Handle, 1);
  index_input += 1;
...
tBleStatus hci_le_request_peer_sca(uint16_t Connection_Handle)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_request_peer_sca_cp0 *cp0 = (hci_le_request_peer_sca_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                      ...
                                      uint8_t Codec_Configuration[])
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_setup_iso_data_path_cp0 *cp0 = (hci_le_setup_iso_data_path_cp0*)(cmd_buffer);
  hci_le_setup_iso_data_path_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
  cp0->Data_Path_Direction = htob(Data_Path_Direction, 1);
  index_input += 1;
  cp0->Data_Path_ID = htob(Data_Path_ID, 1);
  index_input += 1;
  Osal_MemCpy((void *) &cp0->Codec_ID, (const void *) Codec_ID, 5);
  index_input += 5;
  Osal_MemCpy((void *) &cp0->Controller_Delay, (const void *) Controller_Delay, 3);
  index_input += 3;
  cp0->Codec_Configuration_Length = htob(Codec_Configuration_Length, 1);
  index_input += 1;
  /* var_len_data input */
  {
    Osal_MemCpy((void *) &cp0->Codec_Configuration, (const void *) Codec_Configuration, Codec_Configuration_Length*sizeof(uint8_t));
    index_input += Codec_Configuration_Length*sizeof(uint8_t);
  }
  Osal_MemSet(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x06e;
                                       ...
                                       uint8_t Data_Path_Direction)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_remove_iso_data_path_cp0 *cp0 = (hci_le_remove_iso_data_path_cp0*)(cmd_buffer);
  hci_le_remove_iso_data_path_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                    ...
                                    uint8_t Payload_Type)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_iso_transmit_test_cp0 *cp0 = (hci_le_iso_transmit_test_cp0*)(cmd_buffer);
  hci_le_iso_transmit_test_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
  cp0->Payload_Type = htob(Payload_Type, 1);
  index_input += 1;
  Osal_MemSet(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x070;
                                   ...
                                   uint8_t Payload_Type)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_iso_receive_test_cp0 *cp0 = (hci_le_iso_receive_test_cp0*)(cmd_buffer);
  hci_le_iso_receive_test_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                         ...
                                         uint32_t *Failed_Packet_Count)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_iso_read_test_counters_cp0 *cp0 = (hci_le_iso_read_test_counters_cp0*)(cmd_buffer);
  hci_le_iso_read_test_counters_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
  ...
  *Received_Packet_Count = btoh(resp.Received_Packet_Count, 4);
  *Missed_Packet_Count = btoh(resp.Missed_Packet_Count, 4);
  *Failed_Packet_Count = btoh(resp.Failed_Packet_Count, 4);
  return BLE_STATUS_SUCCESS;
}
                               ...
                               uint32_t *Failed_Packet_Count)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_iso_test_end_cp0 *cp0 = (hci_le_iso_test_end_cp0*)(cmd_buffer);
  hci_le_iso_test_end_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
                                   ...
                                   uint8_t Bit_Value)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_set_host_feature_cp0 *cp0 = (hci_le_set_host_feature_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Bit_Number = htob(Bit_Number, 1);
  index_input += 1;
  cp0->Bit_Value = htob(Bit_Value, 1);
  index_input += 1;
  Osal_MemSet(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x074;
                                        ...
                                        uint32_t *Duplicate_Packets)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_read_iso_link_quality_cp0 *cp0 = (hci_le_read_iso_link_quality_cp0*)(cmd_buffer);
  hci_le_read_iso_link_quality_rp0 resp;
  Osal_MemSet(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;
  ...
  *Tx_UnACKed_Packets = btoh(resp.Tx_UnACKed_Packets, 4);
  *Tx_Flushed_Packets = btoh(resp.Tx_Flushed_Packets, 4);
  *Tx_Last_Subevent_Packets = btoh(resp.Tx_Last_Subevent_Packets, 4);
  *Retransmitted_Packets = btoh(resp.Retransmitted_Packets, 4);
  *CRC_Error_Packets = btoh(resp.CRC_Error_Packets, 4);
  *Rx_Unreceived_Packets = btoh(resp.Rx_Unreceived_Packets, 4);
  *Duplicate_Packets = btoh(resp.Duplicate_Packets, 4);
  return BLE_STATUS_SUCCESS;
}
                                                   ...
                                                   uint8_t Change_Reasons)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_set_data_related_address_changes_cp0 *cp0 = (hci_le_set_data_related_address_changes_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Advertising_Handle = htob(Advertising_Handle, 1);
  index_input += 1;
  cp0->Change_Reasons = htob(Change_Reasons, 1);
  index_input += 1;
  Osal_MemSet(&rq, 0, sizeof(rq));
  rq.ogf = 0x08;
  rq.ocf = 0x07c;
                                      ...
                                      uint16_t Supervision_Timeout)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_set_default_subrate_cp0 *cp0 = (hci_le_set_default_subrate_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Subrate_Min = htob(Subrate_Min, 2);
  index_input += 2;
  cp0->Subrate_Max = htob(Subrate_Max, 2);
  index_input += 2;
  cp0->Max_Latency = htob(Max_Latency, 2);
  index_input += 2;
  cp0->Continuation_Number = htob(Continuation_Number, 2);
  index_input += 2;
  cp0->Supervision_Timeout = htob(Supervision_Timeout, 2);
  index_input += 2;
  Osal_MemSet(&rq, 0, sizeof(rq));
                                  ...
                                  uint16_t Supervision_Timeout)
{
  struct hci_request rq;
  uint8_t cmd_buffer[258];
  hci_le_subrate_request_cp0 *cp0 = (hci_le_subrate_request_cp0*)(cmd_buffer);
  tBleStatus status = 0;
  uint8_t index_input = 0;
  cp0->Connection_Handle = htob(Connection_Handle, 2);
  index_input += 2;

...
typedef PACKED(struct) packed_CIS_Conn_Handles_t_s {
  /** Connection handle of the CIS in the CIG.
   *  Values:
   *  - 0x0000 ... 0x0EFF
   */
  uint16_t Connection_Handle;
} packed_CIS_Conn_Handles_t;
...
typedef PACKED(struct) packed_BIS_t_s {
...
typedef PACKED(struct) packed_cid_t_s {
...
/** Documentation for C struct conn_cid_t */
typedef PACKED(struct) packed_conn_cid_t_s {
  /** Array of up to 5 two-octet values that represent the local channel endpoints.
   *  When receiving an event with Event_Type = 0x00 (L2CAP_CFC_CONN_REQ) or
   *  0x02 (L2CAP_ECFC_CONN_REQ), all CID values are equal to 0x0000. On the
   *  Requester side (Channel Initiator) receiving an event with Event_Type =
   *  0x01 (L2CAP_ECFC_CONN_RSP), a value equal to 0x0000 means that the
   *  requested channel has not been created.
   *  Values:
   *  - 0x0040 ... 0x007F
   */
  uint16_t Local_CID;
  /** Array of up to 5 two-octet values that represent the peer channel endpoints.
   *  When receiving an event with Event_Type = 0x00 (L2CAP_CFC_CONN_REQ) or
   *  0x02 (L2CAP_ECFC_CONN_REQ), all CID values are equal to 0x0000. On the
   *  Requester side (Channel Initiator) receiving an event with Event_Type =
   *  0x01 (L2CAP_ECFC_CONN_RSP), a value equal to 0x0000 means that the
...
/** Documentation for C struct local_reconf_cid_t */
typedef PACKED(struct) packed_local_reconf_cid_t_s {
  /** Array of up to 5 two-octet values that represent the local channel endpoints
...
/** Documentation for C struct Connection_Handle_t */
typedef PACKED(struct) packed_Connection_Handle_t_s {
  /** The connection handles of the BISes in the BIG.
   *  Values:
   *  - 0x0000 ... 0x0EFF
   */
  uint16_t Connection_Handle;
} packed_Connection_Handle_t;
...
typedef PACKED(struct) hci_le_set_cig_parameters_rp0_s {
  ...
  uint8_t CIG_ID;
  uint8_t CIS_Count;
  packed_CIS_Conn_Handles_t CIS_Conn_Handles[(HCI_MAX_PAYLOAD_SIZE - 3)/sizeof(packed_CIS_Conn_Handles_t)];
...
typedef PACKED(struct) hci_le_big_create_sync_cp0_s {
  ...
  uint8_t Num_BIS;
  packed_BIS_t BIS[(HCI_MAX_PAYLOAD_SIZE - 24)/sizeof(packed_BIS_t)];
...
typedef PACKED(struct) aci_gatt_srv_multi_notify_cp0_s {
  ...
  uint8_t Flags;
  uint8_t Num_Of_Attr;
  packed_Gatt_Srv_Notify_Attr_t Gatt_Srv_Notify_Attr[(HCI_MAX_PAYLOAD_SIZE - 4)/sizeof(packed_Gatt_Srv_Notify_Attr_t)];
...
typedef PACKED(struct) aci_gatt_eatt_srv_init_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_srv_init_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_prepare_write_req_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attr_Handle;
  uint16_t Val_Offset;
...
} aci_gatt_eatt_clt_prepare_write_req_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_prepare_write_req_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_prepare_write_req_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_execute_write_req_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t Execute;
} aci_gatt_eatt_clt_execute_write_req_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_execute_write_req_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_execute_write_req_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_disc_all_primary_services_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
} aci_gatt_eatt_clt_disc_all_primary_services_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_disc_all_primary_services_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_disc_all_primary_services_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_disc_primary_service_by_uuid_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t UUID_Type;
  packed_UUID_t UUID;
} aci_gatt_eatt_clt_disc_primary_service_by_uuid_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_disc_primary_service_by_uuid_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_disc_primary_service_by_uuid_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_find_included_services_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Start_Handle;
  uint16_t End_Handle;
} aci_gatt_eatt_clt_find_included_services_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_find_included_services_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_find_included_services_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_disc_all_char_of_service_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Start_Handle;
  uint16_t End_Handle;
} aci_gatt_eatt_clt_disc_all_char_of_service_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_disc_all_char_of_service_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_disc_all_char_of_service_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_disc_char_by_uuid_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Start_Handle;
  uint16_t End_Handle;
  uint8_t UUID_Type;
  packed_UUID_t UUID;
} aci_gatt_eatt_clt_disc_char_by_uuid_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_disc_char_by_uuid_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_disc_char_by_uuid_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_disc_all_char_desc_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Char_Handle;
  uint16_t End_Handle;
} aci_gatt_eatt_clt_disc_all_char_desc_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_disc_all_char_desc_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_disc_all_char_desc_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_read_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attr_Handle;
} aci_gatt_eatt_clt_read_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_read_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_read_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_read_using_char_uuid_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Start_Handle;
  uint16_t End_Handle;
  uint8_t UUID_Type;
  packed_UUID_t UUID;
} aci_gatt_eatt_clt_read_using_char_uuid_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_read_using_char_uuid_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_read_using_char_uuid_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_read_long_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attr_Handle;
  uint16_t Val_Offset;
} aci_gatt_eatt_clt_read_long_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_read_long_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_read_long_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_read_multiple_char_value_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t Number_of_Handles;
  packed_Handle_Entry_t Handle_Entry[(HCI_MAX_PAYLOAD_SIZE - 5)/sizeof(packed_Handle_Entry_t)];
} aci_gatt_eatt_clt_read_multiple_char_value_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_read_multiple_char_value_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_read_multiple_char_value_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_write_nwk_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attr_Handle;
  uint16_t Attribute_Val_Length;
  uint8_t Attribute_Val[(HCI_MAX_PAYLOAD_SIZE - 8)/sizeof(uint8_t)];
} aci_gatt_eatt_clt_write_nwk_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_write_nwk_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_write_nwk_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_write_long_nwk_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attr_Handle;
  uint16_t Val_Offset;
  uint16_t Attribute_Val_Length;
  uint8_t Attribute_Val[(HCI_MAX_PAYLOAD_SIZE - 10)/sizeof(uint8_t)];
} aci_gatt_eatt_clt_write_long_nwk_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_write_long_nwk_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_write_long_nwk_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_write_char_reliable_nwk_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attr_Handle;
  uint16_t Val_Offset;
  uint16_t Attribute_Val_Length;
  uint8_t Attribute_Val[(HCI_MAX_PAYLOAD_SIZE - 10)/sizeof(uint8_t)];
} aci_gatt_eatt_clt_write_char_reliable_nwk_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_write_char_reliable_nwk_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_write_char_reliable_nwk_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_write_without_resp_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attr_Handle;
  uint16_t Attribute_Val_Length;
  uint8_t Attribute_Val[(HCI_MAX_PAYLOAD_SIZE - 8)/sizeof(uint8_t)];
} aci_gatt_eatt_clt_write_without_resp_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_write_without_resp_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_write_without_resp_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_confirm_indication_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
} aci_gatt_eatt_clt_confirm_indication_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_confirm_indication_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_confirm_indication_rp0;

typedef PACKED(struct) aci_gatt_eatt_srv_notify_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attr_Handle;
  uint8_t Flags;
...
} aci_gatt_eatt_srv_notify_cp0;

typedef PACKED(struct) aci_gatt_eatt_srv_notify_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_srv_notify_rp0;

typedef PACKED(struct) aci_gatt_eatt_srv_exec_write_resp_nwk_cp0_s {
  uint16_t Conn_Handle;
  uint16_t CID;
  uint8_t Exec;
} aci_gatt_eatt_srv_exec_write_resp_nwk_cp0;

typedef PACKED(struct) aci_gatt_eatt_srv_exec_write_resp_nwk_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_srv_exec_write_resp_nwk_rp0;

typedef PACKED(struct) aci_gatt_eatt_srv_authorize_resp_nwk_cp0_s {
  uint16_t Conn_Handle;
  uint16_t CID;
  uint16_t Attr_Handle;
  uint8_t Operation_Type;
...
} aci_gatt_eatt_srv_authorize_resp_nwk_cp0;

typedef PACKED(struct) aci_gatt_eatt_srv_authorize_resp_nwk_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_srv_authorize_resp_nwk_rp0;

typedef PACKED(struct) aci_gatt_eatt_srv_multi_notify_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t Flags;
  uint8_t Num_Of_Attr;
  packed_Gatt_Srv_Notify_Attr_t Gatt_Srv_Notify_Attr[(HCI_MAX_PAYLOAD_SIZE - 6)/sizeof(packed_Gatt_Srv_Notify_Attr_t)];
} aci_gatt_eatt_srv_multi_notify_cp0;

typedef PACKED(struct) aci_gatt_eatt_srv_multi_notify_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_srv_multi_notify_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_read_multiple_var_len_char_value_cp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t Number_of_Handles;
  packed_Handle_Entry_t Handle_Entry[(HCI_MAX_PAYLOAD_SIZE - 5)/sizeof(packed_Handle_Entry_t)];
} aci_gatt_eatt_clt_read_multiple_var_len_char_value_cp0;

typedef PACKED(struct) aci_gatt_eatt_clt_read_multiple_var_len_char_value_rp0_s {
  uint8_t Status;
} aci_gatt_eatt_clt_read_multiple_var_len_char_value_rp0;
...
typedef PACKED(struct) aci_l2cap_ecfc_connection_req_cp0_s {
  uint16_t Connection_Handle;
  uint16_t SPSM;
  uint16_t MTU;
  uint16_t MPS;
  uint8_t CID_Count;
  packed_cid_t cid[(HCI_MAX_PAYLOAD_SIZE - 9)/sizeof(packed_cid_t)];
} aci_l2cap_ecfc_connection_req_cp0;

typedef PACKED(struct) aci_l2cap_ecfc_connection_req_rp0_s {
  uint8_t Status;
} aci_l2cap_ecfc_connection_req_rp0;

typedef PACKED(struct) aci_l2cap_ecfc_connection_resp_cp0_s {
  uint16_t Connection_Handle;
  uint8_t Identifier;
  uint16_t MTU;
  uint16_t MPS;
  uint16_t Result;
  uint8_t CID_Count;
  packed_cid_t cid[(HCI_MAX_PAYLOAD_SIZE - 10)/sizeof(packed_cid_t)];
} aci_l2cap_ecfc_connection_resp_cp0;

typedef PACKED(struct) aci_l2cap_ecfc_connection_resp_rp0_s {
  uint8_t Status;
} aci_l2cap_ecfc_connection_resp_rp0;

typedef PACKED(struct) aci_l2cap_ecfc_reconfigure_req_cp0_s {
  uint16_t Connection_Handle;
  uint16_t MTU;
  uint16_t MPS;
  uint8_t CID_Count;
  packed_cid_t cid[(HCI_MAX_PAYLOAD_SIZE - 7)/sizeof(packed_cid_t)];
} aci_l2cap_ecfc_reconfigure_req_cp0;

typedef PACKED(struct) aci_l2cap_ecfc_reconfigure_req_rp0_s {
  uint8_t Status;
} aci_l2cap_ecfc_reconfigure_req_rp0;

typedef PACKED(struct) aci_l2cap_ecfc_reconfigure_resp_cp0_s {
  uint16_t Connection_Handle;
  uint8_t Identifier;
  uint16_t Result;
} aci_l2cap_ecfc_reconfigure_resp_cp0;

typedef PACKED(struct) aci_l2cap_ecfc_reconfigure_resp_rp0_s {
  uint8_t Status;
} aci_l2cap_ecfc_reconfigure_resp_rp0;
...
typedef PACKED(struct) aci_l2cap_cos_connection_event_rp0_s {
  uint16_t Connection_Handle;
  uint8_t Event_Type;
  uint8_t Identifier;
  uint16_t SPSM;
  ...
  uint16_t Result;
  uint8_t CID_Count;
  packed_conn_cid_t conn_cid[(HCI_MAX_PAYLOAD_SIZE - 15)/sizeof(packed_conn_cid_t)];
} aci_l2cap_cos_connection_event_rp0;

typedef PACKED(struct) aci_l2cap_ecfc_reconfiguration_event_rp0_s {
  uint16_t Connection_Handle;
  uint8_t Event_Type;
  uint16_t Result;
  uint8_t Identifier;
  ...
  uint16_t Peer_MPS;
  uint8_t CID_Count;
  packed_local_reconf_cid_t local_reconf_cid[(HCI_MAX_PAYLOAD_SIZE - 11)/sizeof(packed_local_reconf_cid_t)];
} aci_l2cap_ecfc_reconfiguration_event_rp0;
...
typedef PACKED(struct) aci_gatt_eatt_srv_attribute_modified_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attr_Handle;
  uint16_t Attr_Data_Length;
  uint8_t Attr_Data[(HCI_MAX_PAYLOAD_SIZE - 8)/sizeof(uint8_t)];
} aci_gatt_eatt_srv_attribute_modified_event_rp0;

typedef PACKED(struct) aci_gatt_eatt_proc_timeout_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
} aci_gatt_eatt_proc_timeout_event_rp0;

typedef PACKED(struct) aci_eatt_clt_find_info_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t Format;
  uint16_t Event_Data_Length;
  uint8_t Handle_UUID_Pair[(HCI_MAX_PAYLOAD_SIZE - 7)/sizeof(uint8_t)];
} aci_eatt_clt_find_info_resp_event_rp0;

typedef PACKED(struct) aci_eatt_clt_find_by_type_value_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t Num_of_Handle_Pair;
...
} aci_eatt_clt_find_by_type_value_resp_event_rp0;

typedef PACKED(struct) aci_eatt_clt_read_by_type_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t Handle_Value_Pair_Length;
  uint16_t Data_Length;
  uint8_t Handle_Value_Pair_Data[(HCI_MAX_PAYLOAD_SIZE - 7)/sizeof(uint8_t)];
} aci_eatt_clt_read_by_type_resp_event_rp0;

typedef PACKED(struct) aci_eatt_clt_read_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Event_Data_Length;
  uint8_t Attribute_Value[(HCI_MAX_PAYLOAD_SIZE - 6)/sizeof(uint8_t)];
} aci_eatt_clt_read_resp_event_rp0;

typedef PACKED(struct) aci_eatt_clt_read_blob_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Event_Data_Length;
  uint8_t Attribute_Value[(HCI_MAX_PAYLOAD_SIZE - 6)/sizeof(uint8_t)];
} aci_eatt_clt_read_blob_resp_event_rp0;

typedef PACKED(struct) aci_eatt_clt_read_multiple_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Event_Data_Length;
  uint8_t Set_Of_Values[(HCI_MAX_PAYLOAD_SIZE - 6)/sizeof(uint8_t)];
} aci_eatt_clt_read_multiple_resp_event_rp0;

typedef PACKED(struct) aci_eatt_clt_read_by_group_type_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t Attribute_Data_Length;
  uint16_t Data_Length;
  uint8_t Attribute_Data_List[(HCI_MAX_PAYLOAD_SIZE - 7)/sizeof(uint8_t)];
} aci_eatt_clt_read_by_group_type_resp_event_rp0;

typedef PACKED(struct) aci_eatt_clt_prepare_write_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attribute_Handle;
  uint16_t Offset;
...
} aci_eatt_clt_prepare_write_resp_event_rp0;

typedef PACKED(struct) aci_eatt_clt_exec_write_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
} aci_eatt_clt_exec_write_resp_event_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_indication_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attribute_Handle;
  uint16_t Attribute_Value_Length;
  uint8_t Attribute_Value[(HCI_MAX_PAYLOAD_SIZE - 8)/sizeof(uint8_t)];
} aci_gatt_eatt_clt_indication_event_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_notification_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attribute_Handle;
  uint16_t Attribute_Value_Length;
  uint8_t Attribute_Value[(HCI_MAX_PAYLOAD_SIZE - 8)/sizeof(uint8_t)];
} aci_gatt_eatt_clt_notification_event_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_proc_complete_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t Error_Code;
} aci_gatt_eatt_clt_proc_complete_event_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_error_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t Req_Opcode;
  uint16_t Attribute_Handle;
  uint8_t Error_Code;
} aci_gatt_eatt_clt_error_resp_event_rp0;

typedef PACKED(struct) aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Attribute_Handle;
  uint8_t Attribute_Value_Length;
  uint8_t Attribute_Value[(HCI_MAX_PAYLOAD_SIZE - 7)/sizeof(uint8_t)];
} aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event_rp0;

typedef PACKED(struct) aci_gatt_eatt_srv_confirmation_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
} aci_gatt_eatt_srv_confirmation_event_rp0;

typedef PACKED(struct) aci_eatt_srv_exec_write_req_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint8_t Flags;
} aci_eatt_srv_exec_write_req_event_rp0;

typedef PACKED(struct) aci_gatt_eatt_srv_authorize_nwk_event_rp0_s {
  uint16_t Conn_Handle;
  uint16_t CID;
  uint16_t Attr_Handle;
  uint8_t Operation_Type;
  ...
  uint8_t Data_Length;
  uint8_t Data[(HCI_MAX_PAYLOAD_SIZE - 10)/sizeof(uint8_t)];
} aci_gatt_eatt_srv_authorize_nwk_event_rp0;

typedef PACKED(struct) aci_eatt_clt_read_multiple_var_len_resp_event_rp0_s {
  uint16_t Connection_Handle;
  uint16_t CID;
  uint16_t Event_Data_Length;
  uint8_t Set_Of_Values[(HCI_MAX_PAYLOAD_SIZE - 6)/sizeof(uint8_t)];
} aci_eatt_clt_read_multiple_var_len_resp_event_rp0;
...
typedef PACKED(struct) hci_le_create_big_complete_event_rp0_s {
  ...
  uint16_t ISO_Interval;
  uint8_t Num_BIS;
  packed_Connection_Handle_t Connection_Handle[(HCI_MAX_PAYLOAD_SIZE - 18)/sizeof(packed_Connection_Handle_t)];
...
typedef PACKED(struct) hci_le_big_sync_established_event_rp0_s {
  ...
  uint16_t ISO_Interval;
  uint8_t Num_BIS;
  packed_Connection_Handle_t Connection_Handle[(HCI_MAX_PAYLOAD_SIZE - 14)/sizeof(packed_Connection_Handle_t)];
...
uint16_t aci_gatt_eatt_srv_init_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_prepare_write_req_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_execute_write_req_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_disc_all_primary_services_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_disc_primary_service_by_uuid_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_find_included_services_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_disc_all_char_of_service_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_disc_char_by_uuid_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_disc_all_char_desc_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_read_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_read_using_char_uuid_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_read_long_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_read_multiple_char_value_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_write_nwk_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_write_long_nwk_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_write_char_reliable_nwk_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_write_without_resp_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_confirm_indication_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_srv_notify_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_srv_exec_write_resp_nwk_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_srv_authorize_resp_nwk_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_srv_multi_notify_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_gatt_eatt_clt_read_multiple_var_len_char_value_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
...
uint16_t aci_l2cap_ecfc_connection_req_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_l2cap_ecfc_connection_resp_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_l2cap_ecfc_reconfigure_req_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
uint16_t aci_l2cap_ecfc_reconfigure_resp_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length);
...
#endif
#if (!defined(HCI_LE_READ_ADVERTISING_CHANNEL_TX_POWER_ENABLED) || HCI_LE_READ_ADVERTISING_CHANNEL_TX_POWER_ENABLED) && !HCI_LE_READ_ADVERTISING_CHANNEL_TX_POWER_FORCE_DISABLED
...
#endif
#if (!defined(HCI_LE_READ_WHITE_LIST_SIZE_ENABLED) || HCI_LE_READ_WHITE_LIST_SIZE_ENABLED) && !HCI_LE_READ_WHITE_LIST_SIZE_FORCE_DISABLED
  /* hci_le_read_white_list_size */
  {0x200f, hci_le_read_white_list_size_process},
#endif
#if (!defined(HCI_LE_CLEAR_WHITE_LIST_ENABLED) || HCI_LE_CLEAR_WHITE_LIST_ENABLED) && !HCI_LE_CLEAR_WHITE_LIST_FORCE_DISABLED
  /* hci_le_clear_white_list */
  {0x2010, hci_le_clear_white_list_process},
#endif
#if (!defined(HCI_LE_ADD_DEVICE_TO_WHITE_LIST_ENABLED) || HCI_LE_ADD_DEVICE_TO_WHITE_LIST_ENABLED) && !HCI_LE_ADD_DEVICE_TO_WHITE_LIST_FORCE_DISABLED
  /* hci_le_add_device_to_white_list */
  {0x2011, hci_le_add_device_to_white_list_process},
#endif
#if (!defined(HCI_LE_REMOVE_DEVICE_FROM_WHITE_LIST_ENABLED) || HCI_LE_REMOVE_DEVICE_FROM_WHITE_LIST_ENABLED) && !HCI_LE_REMOVE_DEVICE_FROM_WHITE_LIST_FORCE_DISABLED
...
#endif
#if (!defined(HCI_LE_READ_REMOTE_USED_FEATURES_ENABLED) || HCI_LE_READ_REMOTE_USED_FEATURES_ENABLED) && !HCI_LE_READ_REMOTE_USED_FEATURES_FORCE_DISABLED
...
#endif
#if (!defined(HCI_LE_START_ENCRYPTION_ENABLED) || HCI_LE_START_ENCRYPTION_ENABLED) && !HCI_LE_START_ENCRYPTION_FORCE_DISABLED
...
#endif
#if (!defined(HCI_LE_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY_ENABLED) || HCI_LE_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY_ENABLED) && !HCI_LE_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY_FORCE_DISABLED
...
#endif
#if (!defined(HCI_LE_ENHANCED_RECEIVER_TEST_ENABLED) || HCI_LE_ENHANCED_RECEIVER_TEST_ENABLED) && !HCI_LE_ENHANCED_RECEIVER_TEST_FORCE_DISABLED
  /* hci_le_enhanced_receiver_test */
  {0x2033, hci_le_enhanced_receiver_test_process},
#endif
#if (!defined(HCI_LE_ENHANCED_TRANSMITTER_TEST_ENABLED) || HCI_LE_ENHANCED_TRANSMITTER_TEST_ENABLED) && !HCI_LE_ENHANCED_TRANSMITTER_TEST_FORCE_DISABLED
...
#endif
#if (!defined(HCI_LE_REMOVE_DEVICE_FROM_PERIODIC_ADVERTISING_LIST_ENABLED) || HCI_LE_REMOVE_DEVICE_FROM_PERIODIC_ADVERTISING_LIST_ENABLED) && !HCI_LE_REMOVE_DEVICE_FROM_PERIODIC_ADVERTISING_LIST_FORCE_DISABLED
...
#endif
#if (!defined(ACI_GAP_SET_AUTHENTICATION_REQUIREMENT_ENABLED) || ACI_GAP_SET_AUTHENTICATION_REQUIREMENT_ENABLED) && !ACI_GAP_SET_AUTHENTICATION_REQUIREMENT_FORCE_DISABLED
  /* aci_gap_set_authentication_requirement */
  {0xfc86, aci_gap_set_authentication_requirement_process},
#endif
#if (!defined(ACI_GAP_PASS_KEY_RESP_ENABLED) || ACI_GAP_PASS_KEY_RESP_ENABLED) && !ACI_GAP_PASS_KEY_RESP_FORCE_DISABLED
...
#endif
#if (!defined(ACI_GAP_SLAVE_SECURITY_REQ_ENABLED) || ACI_GAP_SLAVE_SECURITY_REQ_ENABLED) && !ACI_GAP_SLAVE_SECURITY_REQ_FORCE_DISABLED
...
#endif
#if (!defined(ACI_GAP_SET_EVENT_MASK_ENABLED) || ACI_GAP_SET_EVENT_MASK_ENABLED) && !ACI_GAP_SET_EVENT_MASK_FORCE_DISABLED
...
#endif
#if (!defined(ACI_GAP_ALLOW_REBOND_ENABLED) || ACI_GAP_ALLOW_REBOND_ENABLED) && !ACI_GAP_ALLOW_REBOND_FORCE_DISABLED
...
#endif
#if (!defined(ACI_GAP_SEND_PAIRING_REQ_ENABLED) || ACI_GAP_SEND_PAIRING_REQ_ENABLED) && !ACI_GAP_SEND_PAIRING_REQ_FORCE_DISABLED
...
#endif
#if (!defined(ACI_GAP_ADD_DEVICES_TO_WHITE_AND_RESOLVING_LIST_ENABLED) || ACI_GAP_ADD_DEVICES_TO_WHITE_AND_RESOLVING_LIST_ENABLED) && !ACI_GAP_ADD_DEVICES_TO_WHITE_AND_RESOLVING_LIST_FORCE_DISABLED
  /* aci_gap_add_devices_to_white_and_resolving_list */
  {0xfcb3, aci_gap_add_devices_to_white_and_resolving_list_process},
#endif
#if (!defined(ACI_GAP_CONFIGURE_WHITE_AND_RESOLVING_LIST_ENABLED) || ACI_GAP_CONFIGURE_WHITE_AND_RESOLVING_LIST_ENABLED) && !ACI_GAP_CONFIGURE_WHITE_AND_RESOLVING_LIST_FORCE_DISABLED
  /* aci_gap_configure_white_and_resolving_list */
  {0xfcb4, aci_gap_configure_white_and_resolving_list_process},
#endif
#if (!defined(ACI_GAP_SET_PERIODIC_ADVERTISING_CONFIGURATION_ENABLED) || ACI_GAP_SET_PERIODIC_ADVERTISING_CONFIGURATION_ENABLED) && !ACI_GAP_SET_PERIODIC_ADVERTISING_CONFIGURATION_FORCE_DISABLED
  /* aci_gap_set_periodic_advertising_configuration */
  {0xfcb5, aci_gap_set_periodic_advertising_configuration_process},
#endif
#if (!defined(ACI_GAP_SET_PERIODIC_ADVERTISING_DATA_NWK_ENABLED) || ACI_GAP_SET_PERIODIC_ADVERTISING_DATA_NWK_ENABLED) && !ACI_GAP_SET_PERIODIC_ADVERTISING_DATA_NWK_FORCE_DISABLED
  /* aci_gap_set_periodic_advertising_data_nwk */
  {0xfcb6, aci_gap_set_periodic_advertising_data_nwk_process},
#endif
#if (!defined(ACI_GAP_SET_PERIODIC_ADVERTISING_ENABLE_ENABLED) || ACI_GAP_SET_PERIODIC_ADVERTISING_ENABLE_ENABLED) && !ACI_GAP_SET_PERIODIC_ADVERTISING_ENABLE_FORCE_DISABLED
  /* aci_gap_set_periodic_advertising_enable */
  {0xfcb7, aci_gap_set_periodic_advertising_enable_process},
#endif
#if (!defined(ACI_GAP_PERIODIC_ADVERTISING_CREATE_SYNC_ENABLED) || ACI_GAP_PERIODIC_ADVERTISING_CREATE_SYNC_ENABLED) && !ACI_GAP_PERIODIC_ADVERTISING_CREATE_SYNC_FORCE_DISABLED
  /* aci_gap_periodic_advertising_create_sync */
  {0xfcb8, aci_gap_periodic_advertising_create_sync_process},
#endif
#if (!defined(ACI_GAP_PERIODIC_ADVERTISING_CREATE_SYNC_CANCEL_ENABLED) || ACI_GAP_PERIODIC_ADVERTISING_CREATE_SYNC_CANCEL_ENABLED) && !ACI_GAP_PERIODIC_ADVERTISING_CREATE_SYNC_CANCEL_FORCE_DISABLED
...
#endif
#if (!defined(ACI_GAP_PERIODIC_ADVERTISING_TERMINATE_SYNC_ENABLED) || ACI_GAP_PERIODIC_ADVERTISING_TERMINATE_SYNC_ENABLED) && !ACI_GAP_PERIODIC_ADVERTISING_TERMINATE_SYNC_FORCE_DISABLED
  /* aci_gap_periodic_advertising_terminate_sync */
  {0xfcc0, aci_gap_periodic_advertising_terminate_sync_process},
#endif
#if (!defined(ACI_GAP_ADD_DEVICE_TO_PERIODIC_ADVERTISER_LIST_ENABLED) || ACI_GAP_ADD_DEVICE_TO_PERIODIC_ADVERTISER_LIST_ENABLED) && !ACI_GAP_ADD_DEVICE_TO_PERIODIC_ADVERTISER_LIST_FORCE_DISABLED
  /* aci_gap_add_device_to_periodic_advertiser_list */
  {0xfcc1, aci_gap_add_device_to_periodic_advertiser_list_process},
#endif
#if (!defined(ACI_GAP_REMOVE_DEVICE_FROM_PERIODIC_ADVERTISING_LIST_ENABLED) || ACI_GAP_REMOVE_DEVICE_FROM_PERIODIC_ADVERTISING_LIST_ENABLED) && !ACI_GAP_REMOVE_DEVICE_FROM_PERIODIC_ADVERTISING_LIST_FORCE_DISABLED
  /* aci_gap_remove_device_from_periodic_advertising_list */
  {0xfcc2, aci_gap_remove_device_from_periodic_advertising_list_process},
#endif
#if (!defined(ACI_GAP_CLEAR_PERIODIC_ADVERTISER_LIST_ENABLED) || ACI_GAP_CLEAR_PERIODIC_ADVERTISER_LIST_ENABLED) && !ACI_GAP_CLEAR_PERIODIC_ADVERTISER_LIST_FORCE_DISABLED
  /* aci_gap_clear_periodic_advertiser_list */
  {0xfcc3, aci_gap_clear_periodic_advertiser_list_process},
#endif
#if (!defined(ACI_GAP_READ_PERIODIC_ADVERTISER_LIST_SIZE_ENABLED) || ACI_GAP_READ_PERIODIC_ADVERTISER_LIST_SIZE_ENABLED) && !ACI_GAP_READ_PERIODIC_ADVERTISER_LIST_SIZE_FORCE_DISABLED
  /* aci_gap_read_periodic_advertiser_list_size */
  {0xfcc4, aci_gap_read_periodic_advertiser_list_size_process},
#endif
#if (!defined(ACI_GAP_SET_PERIODIC_ADVERTISING_RECEIVE_ENABLE_ENABLED) || ACI_GAP_SET_PERIODIC_ADVERTISING_RECEIVE_ENABLE_ENABLED) && !ACI_GAP_SET_PERIODIC_ADVERTISING_RECEIVE_ENABLE_FORCE_DISABLED
  /* aci_gap_set_periodic_advertising_receive_enable */
  {0xfcc5, aci_gap_set_periodic_advertising_receive_enable_process},
#endif
#if (!defined(ACI_GAP_PERIODIC_ADVERTISING_SYNC_TRANSFER_ENABLED) || ACI_GAP_PERIODIC_ADVERTISING_SYNC_TRANSFER_ENABLED) && !ACI_GAP_PERIODIC_ADVERTISING_SYNC_TRANSFER_FORCE_DISABLED
  /* aci_gap_periodic_advertising_sync_transfer */
  {0xfcc6, aci_gap_periodic_advertising_sync_transfer_process},
#endif
#if (!defined(ACI_GAP_PERIODIC_ADVERTISING_SET_INFO_TRANSFER_ENABLED) || ACI_GAP_PERIODIC_ADVERTISING_SET_INFO_TRANSFER_ENABLED) && !ACI_GAP_PERIODIC_ADVERTISING_SET_INFO_TRANSFER_FORCE_DISABLED
  /* aci_gap_periodic_advertising_set_info_transfer */
  {0xfcc7, aci_gap_periodic_advertising_set_info_transfer_process},
#endif
#if (!defined(ACI_GAP_SET_PERIODIC_ADVERTISING_SYNC_TRANSFER_PARAMETERS_ENABLED) || ACI_GAP_SET_PERIODIC_ADVERTISING_SYNC_TRANSFER_PARAMETERS_ENABLED) && !ACI_GAP_SET_PERIODIC_ADVERTISING_SYNC_TRANSFER_PARAMETERS_FORCE_DISABLED
...
#endif
#if (!defined(ACI_GAP_SET_DEFAULT_PERIODIC_ADVERTISING_SYNC_TRANSFER_PARAMETERS_ENABLED) || ACI_GAP_SET_DEFAULT_PERIODIC_ADVERTISING_SYNC_TRANSFER_PARAMETERS_ENABLED) && !ACI_GAP_SET_DEFAULT_PERIODIC_ADVERTISING_SYNC_TRANSFER_PARAMETERS_FORCE_DISABLED
...
#endif
#if (!defined(ACI_GATT_SRV_INIT_ENABLED) || ACI_GATT_SRV_INIT_ENABLED) && !ACI_GATT_SRV_INIT_FORCE_DISABLED
  /* aci_gatt_srv_init */
...
#endif
#if (!defined(ACI_GATT_EATT_SRV_INIT_ENABLED) || ACI_GATT_EATT_SRV_INIT_ENABLED) && !ACI_GATT_EATT_SRV_INIT_FORCE_DISABLED
  /* aci_gatt_eatt_srv_init */
  {0xfd3a, aci_gatt_eatt_srv_init_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_PREPARE_WRITE_REQ_ENABLED) || ACI_GATT_EATT_CLT_PREPARE_WRITE_REQ_ENABLED) && !ACI_GATT_EATT_CLT_PREPARE_WRITE_REQ_FORCE_DISABLED
  /* aci_gatt_eatt_clt_prepare_write_req */
  {0xfd3f, aci_gatt_eatt_clt_prepare_write_req_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_EXECUTE_WRITE_REQ_ENABLED) || ACI_GATT_EATT_CLT_EXECUTE_WRITE_REQ_ENABLED) && !ACI_GATT_EATT_CLT_EXECUTE_WRITE_REQ_FORCE_DISABLED
  /* aci_gatt_eatt_clt_execute_write_req */
  {0xfd40, aci_gatt_eatt_clt_execute_write_req_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_DISC_ALL_PRIMARY_SERVICES_ENABLED) || ACI_GATT_EATT_CLT_DISC_ALL_PRIMARY_SERVICES_ENABLED) && !ACI_GATT_EATT_CLT_DISC_ALL_PRIMARY_SERVICES_FORCE_DISABLED
  /* aci_gatt_eatt_clt_disc_all_primary_services */
  {0xfd41, aci_gatt_eatt_clt_disc_all_primary_services_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_DISC_PRIMARY_SERVICE_BY_UUID_ENABLED) || ACI_GATT_EATT_CLT_DISC_PRIMARY_SERVICE_BY_UUID_ENABLED) && !ACI_GATT_EATT_CLT_DISC_PRIMARY_SERVICE_BY_UUID_FORCE_DISABLED
  /* aci_gatt_eatt_clt_disc_primary_service_by_uuid */
  {0xfd42, aci_gatt_eatt_clt_disc_primary_service_by_uuid_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_FIND_INCLUDED_SERVICES_ENABLED) || ACI_GATT_EATT_CLT_FIND_INCLUDED_SERVICES_ENABLED) && !ACI_GATT_EATT_CLT_FIND_INCLUDED_SERVICES_FORCE_DISABLED
  /* aci_gatt_eatt_clt_find_included_services */
  {0xfd43, aci_gatt_eatt_clt_find_included_services_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_DISC_ALL_CHAR_OF_SERVICE_ENABLED) || ACI_GATT_EATT_CLT_DISC_ALL_CHAR_OF_SERVICE_ENABLED) && !ACI_GATT_EATT_CLT_DISC_ALL_CHAR_OF_SERVICE_FORCE_DISABLED
  /* aci_gatt_eatt_clt_disc_all_char_of_service */
  {0xfd44, aci_gatt_eatt_clt_disc_all_char_of_service_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_DISC_CHAR_BY_UUID_ENABLED) || ACI_GATT_EATT_CLT_DISC_CHAR_BY_UUID_ENABLED) && !ACI_GATT_EATT_CLT_DISC_CHAR_BY_UUID_FORCE_DISABLED
  /* aci_gatt_eatt_clt_disc_char_by_uuid */
  {0xfd45, aci_gatt_eatt_clt_disc_char_by_uuid_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_DISC_ALL_CHAR_DESC_ENABLED) || ACI_GATT_EATT_CLT_DISC_ALL_CHAR_DESC_ENABLED) && !ACI_GATT_EATT_CLT_DISC_ALL_CHAR_DESC_FORCE_DISABLED
  /* aci_gatt_eatt_clt_disc_all_char_desc */
  {0xfd46, aci_gatt_eatt_clt_disc_all_char_desc_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_READ_ENABLED) || ACI_GATT_EATT_CLT_READ_ENABLED) && !ACI_GATT_EATT_CLT_READ_FORCE_DISABLED
  /* aci_gatt_eatt_clt_read */
  {0xfd47, aci_gatt_eatt_clt_read_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_READ_USING_CHAR_UUID_ENABLED) || ACI_GATT_EATT_CLT_READ_USING_CHAR_UUID_ENABLED) && !ACI_GATT_EATT_CLT_READ_USING_CHAR_UUID_FORCE_DISABLED
  /* aci_gatt_eatt_clt_read_using_char_uuid */
  {0xfd48, aci_gatt_eatt_clt_read_using_char_uuid_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_READ_LONG_ENABLED) || ACI_GATT_EATT_CLT_READ_LONG_ENABLED) && !ACI_GATT_EATT_CLT_READ_LONG_FORCE_DISABLED
  /* aci_gatt_eatt_clt_read_long */
  {0xfd49, aci_gatt_eatt_clt_read_long_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_READ_MULTIPLE_CHAR_VALUE_ENABLED) || ACI_GATT_EATT_CLT_READ_MULTIPLE_CHAR_VALUE_ENABLED) && !ACI_GATT_EATT_CLT_READ_MULTIPLE_CHAR_VALUE_FORCE_DISABLED
  /* aci_gatt_eatt_clt_read_multiple_char_value */
  {0xfd4a, aci_gatt_eatt_clt_read_multiple_char_value_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_WRITE_NWK_ENABLED) || ACI_GATT_EATT_CLT_WRITE_NWK_ENABLED) && !ACI_GATT_EATT_CLT_WRITE_NWK_FORCE_DISABLED
  /* aci_gatt_eatt_clt_write_nwk */
  {0xfd4b, aci_gatt_eatt_clt_write_nwk_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_WRITE_LONG_NWK_ENABLED) || ACI_GATT_EATT_CLT_WRITE_LONG_NWK_ENABLED) && !ACI_GATT_EATT_CLT_WRITE_LONG_NWK_FORCE_DISABLED
  /* aci_gatt_eatt_clt_write_long_nwk */
  {0xfd4c, aci_gatt_eatt_clt_write_long_nwk_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_WRITE_CHAR_RELIABLE_NWK_ENABLED) || ACI_GATT_EATT_CLT_WRITE_CHAR_RELIABLE_NWK_ENABLED) && !ACI_GATT_EATT_CLT_WRITE_CHAR_RELIABLE_NWK_FORCE_DISABLED
  /* aci_gatt_eatt_clt_write_char_reliable_nwk */
  {0xfd4d, aci_gatt_eatt_clt_write_char_reliable_nwk_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_WRITE_WITHOUT_RESP_ENABLED) || ACI_GATT_EATT_CLT_WRITE_WITHOUT_RESP_ENABLED) && !ACI_GATT_EATT_CLT_WRITE_WITHOUT_RESP_FORCE_DISABLED
  /* aci_gatt_eatt_clt_write_without_resp */
  {0xfd4e, aci_gatt_eatt_clt_write_without_resp_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_CONFIRM_INDICATION_ENABLED) || ACI_GATT_EATT_CLT_CONFIRM_INDICATION_ENABLED) && !ACI_GATT_EATT_CLT_CONFIRM_INDICATION_FORCE_DISABLED
  /* aci_gatt_eatt_clt_confirm_indication */
  {0xfd4f, aci_gatt_eatt_clt_confirm_indication_process},
#endif
#if (!defined(ACI_GATT_EATT_SRV_NOTIFY_ENABLED) || ACI_GATT_EATT_SRV_NOTIFY_ENABLED) && !ACI_GATT_EATT_SRV_NOTIFY_FORCE_DISABLED
  /* aci_gatt_eatt_srv_notify */
  {0xfd50, aci_gatt_eatt_srv_notify_process},
#endif
#if (!defined(ACI_GATT_EATT_SRV_EXEC_WRITE_RESP_NWK_ENABLED) || ACI_GATT_EATT_SRV_EXEC_WRITE_RESP_NWK_ENABLED) && !ACI_GATT_EATT_SRV_EXEC_WRITE_RESP_NWK_FORCE_DISABLED
  /* aci_gatt_eatt_srv_exec_write_resp_nwk */
  {0xfd51, aci_gatt_eatt_srv_exec_write_resp_nwk_process},
#endif
#if (!defined(ACI_GATT_EATT_SRV_AUTHORIZE_RESP_NWK_ENABLED) || ACI_GATT_EATT_SRV_AUTHORIZE_RESP_NWK_ENABLED) && !ACI_GATT_EATT_SRV_AUTHORIZE_RESP_NWK_FORCE_DISABLED
  /* aci_gatt_eatt_srv_authorize_resp_nwk */
  {0xfd52, aci_gatt_eatt_srv_authorize_resp_nwk_process},
#endif
#if (!defined(ACI_GATT_EATT_SRV_MULTI_NOTIFY_ENABLED) || ACI_GATT_EATT_SRV_MULTI_NOTIFY_ENABLED) && !ACI_GATT_EATT_SRV_MULTI_NOTIFY_FORCE_DISABLED
  /* aci_gatt_eatt_srv_multi_notify */
  {0xfd53, aci_gatt_eatt_srv_multi_notify_process},
#endif
#if (!defined(ACI_GATT_EATT_CLT_READ_MULTIPLE_VAR_LEN_CHAR_VALUE_ENABLED) || ACI_GATT_EATT_CLT_READ_MULTIPLE_VAR_LEN_CHAR_VALUE_ENABLED) && !ACI_GATT_EATT_CLT_READ_MULTIPLE_VAR_LEN_CHAR_VALUE_FORCE_DISABLED
  /* aci_gatt_eatt_clt_read_multiple_var_len_char_value */
  {0xfd54, aci_gatt_eatt_clt_read_multiple_var_len_char_value_process},
#endif
...
#endif
#if (!defined(ACI_L2CAP_CFC_CONNECTION_REQ_NWK_ENABLED) || ACI_L2CAP_CFC_CONNECTION_REQ_NWK_ENABLED) && !ACI_L2CAP_CFC_CONNECTION_REQ_NWK_FORCE_DISABLED
  /* aci_l2cap_cfc_connection_req_nwk */
  {0xfd83, aci_l2cap_cfc_connection_req_nwk_process},
#endif
#if (!defined(ACI_L2CAP_CFC_CONNECTION_RESP_NWK_ENABLED) || ACI_L2CAP_CFC_CONNECTION_RESP_NWK_ENABLED) && !ACI_L2CAP_CFC_CONNECTION_RESP_NWK_FORCE_DISABLED
  /* aci_l2cap_cfc_connection_resp_nwk */
  {0xfd84, aci_l2cap_cfc_connection_resp_nwk_process},
#endif
#if (!defined(ACI_L2CAP_SEND_FLOW_CONTROL_CREDITS_ENABLED) || ACI_L2CAP_SEND_FLOW_CONTROL_CREDITS_ENABLED) && !ACI_L2CAP_SEND_FLOW_CONTROL_CREDITS_FORCE_DISABLED
  /* aci_l2cap_send_flow_control_credits */
  {0xfd85, aci_l2cap_send_flow_control_credits_process},
#endif
#if (!defined(ACI_L2CAP_DISCONNECT_ENABLED) || ACI_L2CAP_DISCONNECT_ENABLED) && !ACI_L2CAP_DISCONNECT_FORCE_DISABLED
  /* aci_l2cap_disconnect */
  {0xfd86, aci_l2cap_disconnect_process},
#endif
#if (!defined(ACI_L2CAP_TRANSMIT_SDU_DATA_NWK_ENABLED) || ACI_L2CAP_TRANSMIT_SDU_DATA_NWK_ENABLED) && !ACI_L2CAP_TRANSMIT_SDU_DATA_NWK_FORCE_DISABLED
  /* aci_l2cap_transmit_sdu_data_nwk */
  {0xfd87, aci_l2cap_transmit_sdu_data_nwk_process},
#endif
#if (!defined(ACI_L2CAP_ECFC_CONNECTION_REQ_ENABLED) || ACI_L2CAP_ECFC_CONNECTION_REQ_ENABLED) && !ACI_L2CAP_ECFC_CONNECTION_REQ_FORCE_DISABLED
  /* aci_l2cap_ecfc_connection_req */
  {0xfd88, aci_l2cap_ecfc_connection_req_process},
#endif
#if (!defined(ACI_L2CAP_ECFC_CONNECTION_RESP_ENABLED) || ACI_L2CAP_ECFC_CONNECTION_RESP_ENABLED) && !ACI_L2CAP_ECFC_CONNECTION_RESP_FORCE_DISABLED
  /* aci_l2cap_ecfc_connection_resp */
  {0xfd89, aci_l2cap_ecfc_connection_resp_process},
#endif
#if (!defined(ACI_L2CAP_ECFC_RECONFIGURE_REQ_ENABLED) || ACI_L2CAP_ECFC_RECONFIGURE_REQ_ENABLED) && !ACI_L2CAP_ECFC_RECONFIGURE_REQ_FORCE_DISABLED
  /* aci_l2cap_ecfc_reconfigure_req */
  {0xfd8a, aci_l2cap_ecfc_reconfigure_req_process},
#endif
#if (!defined(ACI_L2CAP_ECFC_RECONFIGURE_RESP_ENABLED) || ACI_L2CAP_ECFC_RECONFIGURE_RESP_ENABLED) && !ACI_L2CAP_ECFC_RECONFIGURE_RESP_FORCE_DISABLED
  /* aci_l2cap_ecfc_reconfigure_resp */
  {0xfd8b, aci_l2cap_ecfc_reconfigure_resp_process},
#endif
...
uint16_t hci_le_extended_create_connection_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  ...
  *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
  ...
  for (i = 0; i < len; i++) {
    ...
    struct_length += 2;
    Extended_Create_Connection_Parameters[i].Conn_Interval_Min = Extended_Create_Connection_Parameters_tmp->Conn_Interval_Min;
    struct_length += 2;
    Extended_Create_Connection_Parameters[i].Conn_Interval_Max = Extended_Create_Connection_Parameters_tmp->Conn_Interval_Max;
    struct_length += 2;
    Extended_Create_Connection_Parameters[i].Conn_Latency = Extended_Create_Connection_Parameters_tmp->Conn_Latency;
    struct_length += 2;
    ...
    struct_length += 2;
    Extended_Create_Connection_Parameters[i].Minimum_CE_Length = Extended_Create_Connection_Parameters_tmp->Minimum_CE_Length;
    struct_length += 2;
    Extended_Create_Connection_Parameters[i].Maximum_CE_Length = Extended_Create_Connection_Parameters_tmp->Maximum_CE_Length;
    struct_length += 2;
  }
...
/* Response len: 1 + 1 + 1 + struct_length */
uint16_t hci_le_set_cig_parameters_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  ...
  CIS_Conn_Handles_t CIS_Conn_Handles[HCI_MAX_PAYLOAD_SIZE/sizeof(CIS_Conn_Handles_t)] = {0};
...
fail:
  ...
  {
    int i;
    for (i = 0; i < rp0->CIS_Count; i++) {
      if (buffer_out_max_length < (output_size + (sizeof(uint16_t)) + 6)) { return 0; }
      rp0->CIS_Conn_Handles[i].Connection_Handle = CIS_Conn_Handles[i].Connection_Handle;
...
/* tBleStatus hci_le_big_create_sync(uint8_t BIG_Handle,
                                  ...
                                  BIS_t BIS[]);
 */
/* Command len: 1 + 2 + 1 + 16 + 1 + 2 + 1 + struct_length */
/* Response len: 1 */
uint16_t hci_le_big_create_sync_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  hci_le_big_create_sync_cp0 *cp0 = (hci_le_big_create_sync_cp0 *)(buffer_in + (0));
  BIS_t BIS[HCI_MAX_PAYLOAD_SIZE/sizeof(BIS_t)];
  ...
  *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
  ...
  for (i = 0; i < cp0->Num_BIS; i++) {
    packed_BIS_t *BIS_tmp = (packed_BIS_t *)(((uint8_t *)cp0->BIS) + struct_length);
    BIS[i].BIS = BIS_tmp->BIS;
    struct_length += 1;
  }
  if(buffer_in_length != 1 + 2 + 1 + 16 + 1 + 2 + 1 + struct_length)
  {
    goto fail;
  }
...
uint16_t aci_gatt_clt_read_multiple_char_value_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  ...
  *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
  ...
  int i;
  int struct_length = 0;
  if(cp0->Number_of_Handles > HCI_MAX_PAYLOAD_SIZE/sizeof(Handle_Entry_t))
  {
    cp0->Number_of_Handles = 0;
    goto fail;
  }
  for (i = 0; i < cp0->Number_of_Handles; i++) {
    packed_Handle_Entry_t *Handle_Entry_tmp = (packed_Handle_Entry_t *)(((uint8_t *)cp0->Handle_Entry) + struct_length);
    Handle_Entry[i].Handle = Handle_Entry_tmp->Handle;
    struct_length += 2;
  }
  if(buffer_in_length != 2 + 1 + struct_length)
  {
    goto fail;
  }
 ...
 */
/* Command len: 2 + 1 + 1 + struct_length */
/* Response len: 1 */
uint16_t aci_gatt_srv_multi_notify_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  ...
  *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
  ...
  if(buffer_in_length != 2 + 1 + 1 + struct_length)
  {
    goto fail;
  }
...
{
  /* Input params */
  aci_gatt_eatt_clt_prepare_write_req_cp0 *cp0 = (aci_gatt_eatt_clt_prepare_write_req_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_prepare_write_req(cp0->Connection_Handle /* 2 */,
                                                cp0->CID /* 2 */,
                                                cp0->Attr_Handle /* 2 */,
                                                cp0->Val_Offset /* 2 */,
                                                cp0->Attribute_Val_Length /* 2 */,
...
{
  /* Input params */
  aci_gatt_eatt_clt_execute_write_req_cp0 *cp0 = (aci_gatt_eatt_clt_execute_write_req_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_execute_write_req(cp0->Connection_Handle /* 2 */,
                                                cp0->CID /* 2 */,
                                                cp0->Execute /* 1 */);
fail:
  buffer_out[0] = 0x04;
...
{
  /* Input params */
  aci_gatt_eatt_clt_disc_all_primary_services_cp0 *cp0 = (aci_gatt_eatt_clt_disc_all_primary_services_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_disc_all_primary_services(cp0->Connection_Handle /* 2 */,
                                                        cp0->CID /* 2 */);
fail:
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0F;
...
{
  /* Input params */
  aci_gatt_eatt_clt_disc_primary_service_by_uuid_cp0 *cp0 = (aci_gatt_eatt_clt_disc_primary_service_by_uuid_cp0 *)(buffer_in + (0));
  UUID_t UUID;
  ...
  *status = aci_gatt_eatt_clt_disc_primary_service_by_uuid(cp0->Connection_Handle /* 2 */,
                                                           cp0->CID /* 2 */,
                                                           cp0->UUID_Type /* 1 */,
                                                           &UUID /* (cp0->UUID_Type == 1 ? 2 : (cp0->UUID_Type == 2 ? 16 : 0)) */);
fail:
...
{
  /* Input params */
  aci_gatt_eatt_clt_find_included_services_cp0 *cp0 = (aci_gatt_eatt_clt_find_included_services_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_find_included_services(cp0->Connection_Handle /* 2 */,
                                                     cp0->CID /* 2 */,
                                                     cp0->Start_Handle /* 2 */,
                                                     cp0->End_Handle /* 2 */);
fail:
...
{
  /* Input params */
  aci_gatt_eatt_clt_disc_all_char_of_service_cp0 *cp0 = (aci_gatt_eatt_clt_disc_all_char_of_service_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_disc_all_char_of_service(cp0->Connection_Handle /* 2 */,
                                                       cp0->CID /* 2 */,
                                                       cp0->Start_Handle /* 2 */,
                                                       cp0->End_Handle /* 2 */);
fail:
...
{
  /* Input params */
  aci_gatt_eatt_clt_disc_char_by_uuid_cp0 *cp0 = (aci_gatt_eatt_clt_disc_char_by_uuid_cp0 *)(buffer_in + (0));
  UUID_t UUID;
  ...
  *status = aci_gatt_eatt_clt_disc_char_by_uuid(cp0->Connection_Handle /* 2 */,
                                                cp0->CID /* 2 */,
                                                cp0->Start_Handle /* 2 */,
                                                cp0->End_Handle /* 2 */,
                                                cp0->UUID_Type /* 1 */,
...
{
  /* Input params */
  aci_gatt_eatt_clt_disc_all_char_desc_cp0 *cp0 = (aci_gatt_eatt_clt_disc_all_char_desc_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_disc_all_char_desc(cp0->Connection_Handle /* 2 */,
                                                 cp0->CID /* 2 */,
                                                 cp0->Char_Handle /* 2 */,
                                                 cp0->End_Handle /* 2 */);
fail:
...
{
  /* Input params */
  aci_gatt_eatt_clt_read_cp0 *cp0 = (aci_gatt_eatt_clt_read_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_read(cp0->Connection_Handle /* 2 */,
                                   cp0->CID /* 2 */,
                                   cp0->Attr_Handle /* 2 */);
fail:
  buffer_out[0] = 0x04;
...
{
  /* Input params */
  aci_gatt_eatt_clt_read_using_char_uuid_cp0 *cp0 = (aci_gatt_eatt_clt_read_using_char_uuid_cp0 *)(buffer_in + (0));
  UUID_t UUID;
  ...
  *status = aci_gatt_eatt_clt_read_using_char_uuid(cp0->Connection_Handle /* 2 */,
                                                   cp0->CID /* 2 */,
                                                   cp0->Start_Handle /* 2 */,
                                                   cp0->End_Handle /* 2 */,
                                                   cp0->UUID_Type /* 1 */,
...
{
  /* Input params */
  aci_gatt_eatt_clt_read_long_cp0 *cp0 = (aci_gatt_eatt_clt_read_long_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_read_long(cp0->Connection_Handle /* 2 */,
                                        cp0->CID /* 2 */,
                                        cp0->Attr_Handle /* 2 */,
                                        cp0->Val_Offset /* 2 */);
fail:
...
/* tBleStatus aci_gatt_eatt_clt_read_multiple_char_value(uint16_t Connection_Handle,
                                                      ...
                                                      Handle_Entry_t Handle_Entry[]);
 */
/* Command len: 2 + 2 + 1 + struct_length */
/* Response len: 1 */
uint16_t aci_gatt_eatt_clt_read_multiple_char_value_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  aci_gatt_eatt_clt_read_multiple_char_value_cp0 *cp0 = (aci_gatt_eatt_clt_read_multiple_char_value_cp0 *)(buffer_in + (0));
  Handle_Entry_t Handle_Entry[HCI_MAX_PAYLOAD_SIZE/sizeof(Handle_Entry_t)];
  ...
  *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
  ...
  if(buffer_in_length != 2 + 2 + 1 + struct_length)
  {
    goto fail;
  }

  *status = aci_gatt_eatt_clt_read_multiple_char_value(cp0->Connection_Handle /* 2 */,
                                                       cp0->CID /* 2 */,
                                                       cp0->Number_of_Handles /* 1 */,
                                                       Handle_Entry /* struct_length */);
fail:
...
{
  /* Input params */
  aci_gatt_eatt_clt_write_nwk_cp0 *cp0 = (aci_gatt_eatt_clt_write_nwk_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_write_nwk(cp0->Connection_Handle /* 2 */,
                                        cp0->CID /* 2 */,
                                        cp0->Attr_Handle /* 2 */,
                                        cp0->Attribute_Val_Length /* 2 */,
                                        cp0->Attribute_Val /* cp0->Attribute_Val_Length * (sizeof(uint8_t)) */);
...
{
  /* Input params */
  aci_gatt_eatt_clt_write_long_nwk_cp0 *cp0 = (aci_gatt_eatt_clt_write_long_nwk_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_write_long_nwk(cp0->Connection_Handle /* 2 */,
                                             cp0->CID /* 2 */,
                                             cp0->Attr_Handle /* 2 */,
                                             cp0->Val_Offset /* 2 */,
                                             cp0->Attribute_Val_Length /* 2 */,
...
{
  /* Input params */
  aci_gatt_eatt_clt_write_char_reliable_nwk_cp0 *cp0 = (aci_gatt_eatt_clt_write_char_reliable_nwk_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_write_char_reliable_nwk(cp0->Connection_Handle /* 2 */,
                                                      cp0->CID /* 2 */,
                                                      cp0->Attr_Handle /* 2 */,
                                                      cp0->Val_Offset /* 2 */,
                                                      cp0->Attribute_Val_Length /* 2 */,
...
{
  /* Input params */
  aci_gatt_eatt_clt_write_without_resp_cp0 *cp0 = (aci_gatt_eatt_clt_write_without_resp_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_write_without_resp(cp0->Connection_Handle /* 2 */,
                                                 cp0->CID /* 2 */,
                                                 cp0->Attr_Handle /* 2 */,
                                                 cp0->Attribute_Val_Length /* 2 */,
                                                 cp0->Attribute_Val /* cp0->Attribute_Val_Length * (sizeof(uint8_t)) */);
...
{
  /* Input params */
  aci_gatt_eatt_clt_confirm_indication_cp0 *cp0 = (aci_gatt_eatt_clt_confirm_indication_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_clt_confirm_indication(cp0->Connection_Handle /* 2 */,
                                                 cp0->CID /* 2 */);
fail:
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x0E;
...
{
  /* Input params */
  aci_gatt_eatt_srv_notify_cp0 *cp0 = (aci_gatt_eatt_srv_notify_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_srv_notify(cp0->Connection_Handle /* 2 */,
                                     cp0->CID /* 2 */,
                                     cp0->Attr_Handle /* 2 */,
                                     cp0->Flags /* 1 */,
                                     cp0->Val_Length /* 2 */,
...
{
  /* Input params */
  aci_gatt_eatt_srv_exec_write_resp_nwk_cp0 *cp0 = (aci_gatt_eatt_srv_exec_write_resp_nwk_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_srv_exec_write_resp_nwk(cp0->Conn_Handle /* 2 */,
                                                  cp0->CID /* 2 */,
                                                  cp0->Exec /* 1 */);
fail:
  buffer_out[0] = 0x04;
...
{
  /* Input params */
  aci_gatt_eatt_srv_authorize_resp_nwk_cp0 *cp0 = (aci_gatt_eatt_srv_authorize_resp_nwk_cp0 *)(buffer_in + (0));
  ...
  *status = aci_gatt_eatt_srv_authorize_resp_nwk(cp0->Conn_Handle /* 2 */,
                                                 cp0->CID /* 2 */,
                                                 cp0->Attr_Handle /* 2 */,
                                                 cp0->Operation_Type /* 1 */,
                                                 cp0->Error_Code /* 1 */,
...
{
  /* Input params */
  aci_gatt_eatt_srv_multi_notify_cp0 *cp0 = (aci_gatt_eatt_srv_multi_notify_cp0 *)(buffer_in + (0));
  Gatt_Srv_Notify_Attr_t Gatt_Srv_Notify_Attr[HCI_MAX_PAYLOAD_SIZE/sizeof(Gatt_Srv_Notify_Attr_t)];
  ...
  *status = aci_gatt_eatt_srv_multi_notify(cp0->Connection_Handle /* 2 */,
                                           cp0->CID /* 2 */,
                                           cp0->Flags /* 1 */,
                                           cp0->Num_Of_Attr /* 1 */,
                                           Gatt_Srv_Notify_Attr /* struct_length */);
...
{
  /* Input params */
  aci_gatt_eatt_clt_read_multiple_var_len_char_value_cp0 *cp0 = (aci_gatt_eatt_clt_read_multiple_var_len_char_value_cp0 *)(buffer_in + (0));
  Handle_Entry_t Handle_Entry[HCI_MAX_PAYLOAD_SIZE/sizeof(Handle_Entry_t)];
  ...
  *status = aci_gatt_eatt_clt_read_multiple_var_len_char_value(cp0->Connection_Handle /* 2 */,
                                                               cp0->CID /* 2 */,
                                                               cp0->Number_of_Handles /* 1 */,
                                                               Handle_Entry /* struct_length */);
fail:
...
/* tBleStatus aci_l2cap_ecfc_connection_req(uint16_t Connection_Handle,
                                         ...
                                         cid_t cid[]);
 */
/* Command len: 2 + 2 + 2 + 2 + 1 + struct_length */
/* Response len: 1 */
uint16_t aci_l2cap_ecfc_connection_req_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  aci_l2cap_ecfc_connection_req_cp0 *cp0 = (aci_l2cap_ecfc_connection_req_cp0 *)(buffer_in + (0));
  cid_t cid[HCI_MAX_PAYLOAD_SIZE/sizeof(cid_t)];
  ...
  *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
  ...
  int i;
  int struct_length = 0;
  if(cp0->CID_Count > HCI_MAX_PAYLOAD_SIZE/sizeof(cid_t))
  {
    cp0->CID_Count = 0;
    goto fail;
  }
  for (i = 0; i < cp0->CID_Count; i++) {
    packed_cid_t *cid_tmp = (packed_cid_t *)(((uint8_t *)cp0->cid) + struct_length);
    cid[i].Local_CID = cid_tmp->Local_CID;
    struct_length += 2;
  }
  if(buffer_in_length != 2 + 2 + 2 + 2 + 1 + struct_length)
  {
    goto fail;
  }

  *status = aci_l2cap_ecfc_connection_req(cp0->Connection_Handle /* 2 */,
                                          cp0->SPSM /* 2 */,
                                          cp0->MTU /* 2 */,
                                          cp0->MPS /* 2 */,
                                          cp0->CID_Count /* 1 */,
...
/* tBleStatus aci_l2cap_ecfc_connection_resp(uint16_t Connection_Handle,
                                          ...
                                          cid_t cid[]);
 */
/* Command len: 2 + 1 + 2 + 2 + 2 + 1 + struct_length */
/* Response len: 1 */
uint16_t aci_l2cap_ecfc_connection_resp_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  aci_l2cap_ecfc_connection_resp_cp0 *cp0 = (aci_l2cap_ecfc_connection_resp_cp0 *)(buffer_in + (0));
  cid_t cid[HCI_MAX_PAYLOAD_SIZE/sizeof(cid_t)];
  ...
  *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
  ...
  if(buffer_in_length != 2 + 1 + 2 + 2 + 2 + 1 + struct_length)
  {
    goto fail;
  }

  *status = aci_l2cap_ecfc_connection_resp(cp0->Connection_Handle /* 2 */,
                                           cp0->Identifier /* 1 */,
                                           cp0->MTU /* 2 */,
                                           cp0->MPS /* 2 */,
                                           cp0->Result /* 2 */,
...
/* tBleStatus aci_l2cap_ecfc_reconfigure_req(uint16_t Connection_Handle,
                                          ...
                                          cid_t cid[]);
 */
/* Command len: 2 + 2 + 2 + 1 + struct_length */
/* Response len: 1 */
uint16_t aci_l2cap_ecfc_reconfigure_req_process(uint8_t *buffer_in, uint16_t buffer_in_length, uint8_t *buffer_out, uint16_t buffer_out_max_length)
{
  /* Input params */
  aci_l2cap_ecfc_reconfigure_req_cp0 *cp0 = (aci_l2cap_ecfc_reconfigure_req_cp0 *)(buffer_in + (0));
  cid_t cid[HCI_MAX_PAYLOAD_SIZE/sizeof(cid_t)];
  ...
  *status = BLE_ERROR_INVALID_HCI_CMD_PARAMS;
  ...
  if(buffer_in_length != 2 + 2 + 2 + 1 + struct_length)
  {
    goto fail;
  }

  *status = aci_l2cap_ecfc_reconfigure_req(cp0->Connection_Handle /* 2 */,
                                           cp0->MTU /* 2 */,
                                           cp0->MPS /* 2 */,
                                           cp0->CID_Count /* 1 */,
                                           cid /* struct_length */);
...
{
  /* Input params */
  aci_l2cap_ecfc_reconfigure_resp_cp0 *cp0 = (aci_l2cap_ecfc_reconfigure_resp_cp0 *)(buffer_in + (0));
  ...
  *status = aci_l2cap_ecfc_reconfigure_resp(cp0->Connection_Handle /* 2 */,
                                            cp0->Identifier /* 1 */,
                                            cp0->Result /* 2 */);
fail:
  buffer_out[0] = 0x04;
 ...
 *        performed (which can be also triggered by the Stack to store bonding
 *        information). Stack will try to recover the situation, so there is
 ...
 * @param FW_Error_Type Code identifying the type of error that has occurred in
 *        Bluetooth stack.  0x01: L2CAP layer failed recombining a PDU; 0x02:
 *        GATT layer received an unexpteced response (protocol violation); 0x03:
 *        GATT layer received an unexpteced request (protocol violation); 0x04:
 *        No space to store info GATT database info in NVM (database clean-up
 *        needed or bonding entries to be removed); 0x05: No space to store
 *        bonding info in NVM  (database clean-up  needed or bonding entries to
 *        be removed); 0x06: Link Layer scheduler failed to reschedule slots for
 *        too many times (a system reset is recommended; 0x07: Out of memory
 *        resources for isochronous channels; 0x08: Error in programming timer
 *        for CTE reception functionality.
 *        Values:
 ...
 *        Values:
 *        - 0x0006 (7.50 ms)  ... 0x0C80 (4000.00 ms) 
 * @param Slave_Latency Peripheral latency for the connection in number of
 *        connection events.
 *        Values:
 *        - 0x0000 ... 0x01F3
...
/* Event len: 2 + 1 + 1 + 2 + 2 + 2 + 2 + 2 + 1 + struct_length */
/**
 * @brief Event generated when a request or a response is received from the peer
 *        to create one L2CAP Credit Based Flow Control channel or one or more
 *        (up to 5) L2CAP Enhanced Credit Based Flow Control channels.
 * @param Connection_Handle Connection handle that identifies the connection.
 *        Values:
 *        - 0x0000 ... 0x0EFF
 * @param Event_Type
 *        Values:
 *        - 0x00: L2CAP_CFC_CONN_REQ
 *        - 0x01: L2CAP_CFC_CONN_RESP
 *        - 0x02: L2CAP_ECFC_CONN_REQ
 *        - 0x03: L2CAP_ECFC_CONN_RESP
 * @param Identifier This is the identifier which associates the request to the
 *        response.
 * @param SPSM Simplified Protocol/Service Multiplexer
 *        Values:
 *        - 0x0001 ... 0x00FF
 * @param Peer_MTU The maximum SDU size (in octets) that the remote L2CAP layer
 *        entity can receive on this channel.
 *        Values:
 *        - 64 ... 65535
 * @param Peer_MPS The maximum PDU payload size (in octets) that the remote
 *        L2CAP layer entity can receive on this channel.
 *        Values:
 *        - 64 ... 65535
 * @param Initial_Credits The number of K-frames that can be sent to the L2CAP
 *        layer entity of the peer device as soon as the L2CAP channel is
 *        established.
 * @param Result Result of the connection request.
 *        Values:
 ...
 *        - 0x000D: L2CAP_CONN_FAIL_NO_FURTHER_INFORMATON
 *        - 0x000E: L2CAP_CONN_FAIL_AUTHENTICATION_PENDING
 *        - 0x000F: L2CAP_CONN_FAIL_AUTHORIZATION_PENDING
 * @param CID_Count Number of channels to be created which are present in the
 *        L2CAP Credit Based Connection Request. The effective number of
 *        channels that will be opened can be less than this value (see
 *        Local_CID) .
 *        Values:
 *        - 0x01 ... 0x05
 * @param conn_cid See @ref conn_cid_t
 * @retval None
 */
                                    ...
                                    conn_cid_t conn_cid[])
{
  ...
  if(aci_l2cap_cos_connection_event_preprocess(Connection_Handle, Event_Type, Identifier, SPSM, Peer_MTU, Peer_MPS, Initial_Credits, Result, CID_Count, conn_cid)) return;

  int output_size = 0;
  /* Output params */
  aci_l2cap_cos_connection_event_rp0 *rp0 = (aci_l2cap_cos_connection_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  ...
  rp0->Result = Result;
  rp0->CID_Count = CID_Count;
  {
    int i;
    for (i = 0; i < rp0->CID_Count; i++) {
      rp0->conn_cid[i].Local_CID = conn_cid[i].Local_CID;
      output_size += sizeof(uint16_t);
      rp0->conn_cid[i].Remote_CID = conn_cid[i].Remote_CID;
      output_size += sizeof(uint16_t);
    }
  }
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 1 + 1 + 2 + 2 + 2 + 2 + 2 + 1 + output_size + 2);
  buffer_out[4] = 0x08;
  buffer_out[5] = 0x08;
  send_event(buffer_out, 2 + 1 + 1 + 2 + 2 + 2 + 2 + 2 + 1 + output_size + 6, -1);
}

/* aci_l2cap_ecfc_reconfiguration_event */
/* Event len: 2 + 1 + 2 + 1 + 2 + 2 + 1 + struct_length */
/**
 * @brief Event generated when receiving an L2CAP_CREDIT_BASED_RECONFIGURE_REQ
 *        or an L2CAP_CREDIT_BASED_RECONFIGURE_RSP, to reconfigure one or more
 *        (up to 5) L2CAP Enhanced Credit Based Flow Control channels.
 * @param Connection_Handle Connection handle that identifies the connection.
 *        Values:
 *        - 0x0000 ... 0x0EFF
 ...
 *        L2CAP_ECFC_CONN_RESP. To be ignored if Event_Type is
 *        L2CAP_ECFC_CONN_REQ.
 *        Values:
 ...
 *        response.
 * @param Peer_MTU The maximum SDU size (in octets) that the remote L2CAP layer
 *        entity can receive on this channel after successful reconfiguration.
 *        Values:
 *        - 64 ... 65535
 * @param Peer_MPS The maximum PDU payload size (in octets) that the remote
 *        L2CAP layer entity can receive on this channel after successful
 *        reconfiguration.
 *        Values:
 *        - 64 ... 65535
 * @param CID_Count Number of Channels that are going to be created.
 *        Values:
 *        - 0x01 ... 0x05
 * @param local_reconf_cid See @ref local_reconf_cid_t
 * @retval None
 */
void aci_l2cap_ecfc_reconfiguration_event(uint16_t Connection_Handle,
                                          uint8_t Event_Type,
                                          uint16_t Result,
                                          uint8_t Identifier,
                                          uint16_t Peer_MTU,
                                          uint16_t Peer_MPS,
                                          uint8_t CID_Count,
                                          local_reconf_cid_t local_reconf_cid[])
{
  uint8_t buffer_out[532];
  int output_size = 0;
  /* Output params */
  aci_l2cap_ecfc_reconfiguration_event_rp0 *rp0 = (aci_l2cap_ecfc_reconfiguration_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->Event_Type = Event_Type;
  rp0->Result = Result;
  rp0->Identifier = Identifier;
  ...
  rp0->CID_Count = CID_Count;
  {
    int i;
    for (i = 0; i < rp0->CID_Count; i++) {
      rp0->local_reconf_cid[i].Local_CID = local_reconf_cid[i].Local_CID;
      output_size += sizeof(uint16_t);
    }
  }
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 1 + 2 + 1 + 2 + 2 + 1 + output_size + 2);
  buffer_out[4] = 0x09;
  buffer_out[5] = 0x08;
  send_event(buffer_out, 2 + 1 + 2 + 1 + 2 + 2 + 1 + output_size + 6, -1);
}
 ...
 *        an @ref aci_gap_terminate to disconnect from the peer device.
...
/* Event len: 2 + 2 */
/**
 * @brief Each time Bluetooth stack raises the error code
 ...
 *        one attribute in a single operation. The aci_gatt_srv_resp command
 *        must be sent to give a response to the peer.
                                      ...
                                      uint8_t Data[])
{
  ...
  buffer_out[4] = 0x1d;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 1 + 2 + 1 + Data_Length + 6, -1);
}

/* aci_att_clt_read_multiple_var_len_resp_event */
/* Event len: 2 + 2 + rp0->Event_Data_Length * (sizeof(uint8_t)) */
/**
 * @brief This event is generated in response to a Read Multiple Variable
 *        Request. See aci_gatt_clt_read_multiple_var_len_char_value().
 * @param Connection_Handle Connection handle related to the response
 * @param Event_Data_Length Length of following data
 * @param Set_Of_Values A set of two or more values. A concatenation of
 *        attribute values for each of the attribute handles in the request in
 ...
 * @retval None
 */
void aci_att_clt_read_multiple_var_len_resp_event(uint16_t Connection_Handle,
                                                  uint16_t Event_Data_Length,
                                                  uint8_t Set_Of_Values[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_att_clt_read_multiple_var_len_resp_event_rp0 *rp0 = (aci_att_clt_read_multiple_var_len_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->Event_Data_Length = Event_Data_Length;
  Osal_MemCpy((void *) rp0->Set_Of_Values,(const void *) Set_Of_Values, Event_Data_Length);
  buffer_out[0] = 0x82;
...
/**
 * @brief This event is generated to the application by the GATT server when a
 *        client modifies any attribute on the server using Enhanced ATT bearer,
 *        as consequence of one of the following GATT procedures: - write
 *        without response - write characteristic value - write long
 *        characteristic value - reliable write.
 * @param Connection_Handle The connection handle which modified the attribute.
 * @param CID Local endpoint identifying the EATT channel.
 * @param Attr_Handle Handle of the attribute that was modified.
 * @param Attr_Data_Length Length of Attr_Data in octets
 * @param Attr_Data A concatenation of Handle, Length and Values for each of the
 *        attributes being notified.
 * @retval None
 */
void aci_gatt_eatt_srv_attribute_modified_event(uint16_t Connection_Handle,
                                                uint16_t CID,
                                                uint16_t Attr_Handle,
                                                uint16_t Attr_Data_Length,
                                                uint8_t Attr_Data[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_gatt_eatt_srv_attribute_modified_event_rp0 *rp0 = (aci_gatt_eatt_srv_attribute_modified_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Attr_Handle = Attr_Handle;
  rp0->Attr_Data_Length = Attr_Data_Length;
                                      ...
                                      uint16_t CID)
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_gatt_eatt_proc_timeout_event_rp0 *rp0 = (aci_gatt_eatt_proc_timeout_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  ...
  buffer_out[4] = 0x23;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 6, 21);
}

/* aci_eatt_clt_find_info_resp_event */
/* Event len: 2 + 2 + 1 + 2 + rp0->Event_Data_Length * (sizeof(uint8_t)) */
/**
 * @brief This event is generated in response to a Find Information Request
 *        during a discovery procedure for all the characteristic descriptors.
 *        See aci_gatt_eatt_clt_disc_all_char_desc() and Find Information
 *        Response in Bluetooth Core spec.
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @param Format Format of the hanndle-uuid pairs
 * @param Event_Data_Length Length of Handle_UUID_Pair in octets
 ...
 * @retval None
 */
void aci_eatt_clt_find_info_resp_event(uint16_t Connection_Handle,
                                       uint16_t CID,
                                       uint8_t Format,
                                       uint16_t Event_Data_Length,
                                       uint8_t Handle_UUID_Pair[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_eatt_clt_find_info_resp_event_rp0 *rp0 = (aci_eatt_clt_find_info_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Format = Format;
  rp0->Event_Data_Length = Event_Data_Length;
  ...
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 2 + 1 + 2 + Event_Data_Length + 2);
  buffer_out[4] = 0x24;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 1 + 2 + Event_Data_Length + 6, 23);
}

/* aci_eatt_clt_find_by_type_value_resp_event */
/* Event len: 2 + 2 + 1 + struct_length */
/**
 * @brief This event is generated during a "discover service by UUID" procedure
 *        on Enhanced ATT bearer. See
 *        aci_gatt_eatt_clt_disc_primary_service_by_uuid().
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @param Num_of_Handle_Pair Number of attribute, group handle pairs
 ...
 * @retval None
 */
void aci_eatt_clt_find_by_type_value_resp_event(uint16_t Connection_Handle,
                                                uint16_t CID,
                                                uint8_t Num_of_Handle_Pair,
                                                Attribute_Group_Handle_Pair_t Attribute_Group_Handle_Pair[])
{
  ...
  int output_size = 0;
  /* Output params */
  aci_eatt_clt_find_by_type_value_resp_event_rp0 *rp0 = (aci_eatt_clt_find_by_type_value_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Num_of_Handle_Pair = Num_of_Handle_Pair;
  {
  ...
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 2 + 1 + output_size + 2);
  buffer_out[4] = 0x25;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 1 + output_size + 6, 24);
}

/* aci_eatt_clt_read_by_type_resp_event */
/* Event len: 2 + 2 + 1 + 2 + rp0->Data_Length * (sizeof(uint8_t)) */
/**
 * @brief This event is generated in response to a ATT_READ_BY_TYPE_REQ, during
 *        a "find included service" procedure or a "discover all
 *        characteristics" procedure on a Enhanced ATT bearer. See
 *        aci_gatt_eatt_clt_find_included_services() and
 *        aci_gatt_eatt_clt_disc_all_char_of_service().
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @param Handle_Value_Pair_Length The size of each attribute handle-value pair
 ...
 * @retval None
 */
void aci_eatt_clt_read_by_type_resp_event(uint16_t Connection_Handle,
                                          uint16_t CID,
                                          uint8_t Handle_Value_Pair_Length,
                                          uint16_t Data_Length,
                                          uint8_t Handle_Value_Pair_Data[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_eatt_clt_read_by_type_resp_event_rp0 *rp0 = (aci_eatt_clt_read_by_type_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Handle_Value_Pair_Length = Handle_Value_Pair_Length;
  rp0->Data_Length = Data_Length;
  ...
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 2 + 1 + 2 + Data_Length + 2);
  buffer_out[4] = 0x26;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 1 + 2 + Data_Length + 6, 25);
}

/* aci_eatt_clt_read_resp_event */
/* Event len: 2 + 2 + 2 + rp0->Event_Data_Length * (sizeof(uint8_t)) */
/**
 * @brief This event is generated in response to a Read Request on an Enhanced
 *        ATT bearer. See aci_gatt_eatt_clt_read().
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @param Event_Data_Length Length of following data
 * @param Attribute_Value The value of the attribute.
 * @retval None
 */
void aci_eatt_clt_read_resp_event(uint16_t Connection_Handle,
                                  uint16_t CID,
                                  uint16_t Event_Data_Length,
                                  uint8_t Attribute_Value[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_eatt_clt_read_resp_event_rp0 *rp0 = (aci_eatt_clt_read_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Event_Data_Length = Event_Data_Length;
  Osal_MemCpy((void *) rp0->Attribute_Value,(const void *) Attribute_Value, Event_Data_Length);
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 2 + 2 + Event_Data_Length + 2);
  buffer_out[4] = 0x27;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 2 + Event_Data_Length + 6, 26);
}
...
/**
 * @brief This event can be generated during a read long characteristic value
 *        procedure on an Enhanced ATT bearer. See
 *        aci_gatt_eatt_clt_read_long().
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @param Event_Data_Length Length of following data
 ...
 * @retval None
 */
void aci_eatt_clt_read_blob_resp_event(uint16_t Connection_Handle,
                                       uint16_t CID,
                                       uint16_t Event_Data_Length,
                                       uint8_t Attribute_Value[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_eatt_clt_read_blob_resp_event_rp0 *rp0 = (aci_eatt_clt_read_blob_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Event_Data_Length = Event_Data_Length;
  Osal_MemCpy((void *) rp0->Attribute_Value,(const void *) Attribute_Value, Event_Data_Length);
  ...
  buffer_out[4] = 0x28;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 2 + Event_Data_Length + 6, 27);
}

/* aci_eatt_clt_read_multiple_resp_event */
/* Event len: 2 + 2 + 2 + rp0->Event_Data_Length * (sizeof(uint8_t)) */
/**
 * @brief This event is generated in response to a Read Multiple Request on an
 *        Enhanced ATT bearer. See aci_gatt_eatt_clt_read_multiple_char_value().
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @param Event_Data_Length Length of following data
 * @param Set_Of_Values A set of two or more values. A concatenation of
 ...
 * @retval None
 */
void aci_eatt_clt_read_multiple_resp_event(uint16_t Connection_Handle,
                                           uint16_t CID,
                                           uint16_t Event_Data_Length,
                                           uint8_t Set_Of_Values[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_eatt_clt_read_multiple_resp_event_rp0 *rp0 = (aci_eatt_clt_read_multiple_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Event_Data_Length = Event_Data_Length;
  Osal_MemCpy((void *) rp0->Set_Of_Values,(const void *) Set_Of_Values, Event_Data_Length);
  ...
  buffer_out[4] = 0x29;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 2 + Event_Data_Length + 6, 28);
}
...
/**
 * @brief This event is generated in response to a Read By Group Type Request,
 *        during a "discover all primary services" procedure on an Enhanced ATT
 *        bearer. See aci_gatt_eatt_clt_disc_all_primary_services().
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @param Attribute_Data_Length The size of each attribute data
 * @param Data_Length Length of Attribute_Data_List in octets
 ...
 * @retval None
 */
void aci_eatt_clt_read_by_group_type_resp_event(uint16_t Connection_Handle,
                                                uint16_t CID,
                                                uint8_t Attribute_Data_Length,
                                                uint16_t Data_Length,
                                                uint8_t Attribute_Data_List[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_eatt_clt_read_by_group_type_resp_event_rp0 *rp0 = (aci_eatt_clt_read_by_group_type_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Attribute_Data_Length = Attribute_Data_Length;
  rp0->Data_Length = Data_Length;
  ...
  buffer_out[4] = 0x2a;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 1 + 2 + Data_Length + 6, 29);
}

/* aci_eatt_clt_prepare_write_resp_event */
/* Event len: 2 + 2 + 2 + 2 + 2 + rp0->Part_Attribute_Value_Length * (sizeof(uint8_t)) */
/**
 * @brief This event is generated in response to an ATT_PREPARE_WRITE_REQ during
 *        a write long characteristic value procedure on an Enhanced ATT bearer.
 *        See aci_gatt_eatt_clt_write_long().
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @param Attribute_Handle The handle of the attribute to be written
 * @param Offset The offset of the first octet to be written.
 ...
 * @retval None
 */
void aci_eatt_clt_prepare_write_resp_event(uint16_t Connection_Handle,
                                           uint16_t CID,
                                           uint16_t Attribute_Handle,
                                           uint16_t Offset,
                                           uint16_t Part_Attribute_Value_Length,
                                           uint8_t Part_Attribute_Value[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_eatt_clt_prepare_write_resp_event_rp0 *rp0 = (aci_eatt_clt_prepare_write_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Attribute_Handle = Attribute_Handle;
  rp0->Offset = Offset;
  ...
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 2 + 2 + 2 + 2 + Part_Attribute_Value_Length + 2);
  buffer_out[4] = 0x2b;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 2 + 2 + 2 + Part_Attribute_Value_Length + 6, 31);
}
...
/**
 * @brief This event is generated in response to an ATT Execute Write Request,
 *        during a write long characteristic value procedure on an Enhanced ATT
 *        bearer. See aci_gatt_eatt_clt_write_long().
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @retval None
 */
void aci_eatt_clt_exec_write_resp_event(uint16_t Connection_Handle,
                                        uint16_t CID)
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_eatt_clt_exec_write_resp_event_rp0 *rp0 = (aci_eatt_clt_exec_write_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  ...
  buffer_out[4] = 0x2c;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 6, 32);
}
 ...
 * @retval None
 */
void aci_gatt_eatt_clt_indication_event(uint16_t Connection_Handle,
                                        uint16_t CID,
                                        uint16_t Attribute_Handle,
                                        uint16_t Attribute_Value_Length,
                                        uint8_t Attribute_Value[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_gatt_eatt_clt_indication_event_rp0 *rp0 = (aci_gatt_eatt_clt_indication_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Attribute_Handle = Attribute_Handle;
  rp0->Attribute_Value_Length = Attribute_Value_Length;
  ...
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 2 + 2 + 2 + Attribute_Value_Length + 2);
  buffer_out[4] = 0x2d;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 2 + 2 + Attribute_Value_Length + 6, 33);
}
...
/**
 * @brief This event is generated when a notification is received from the
 *        server on an Enhanced ATT bearer.
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @param Attribute_Handle The handle of the attribute
 * @param Attribute_Value_Length Length of Attribute_Value in octets
 ...
 * @retval None
 */
void aci_gatt_eatt_clt_notification_event(uint16_t Connection_Handle,
                                          uint16_t CID,
                                          uint16_t Attribute_Handle,
                                          uint16_t Attribute_Value_Length,
                                          uint8_t Attribute_Value[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_gatt_eatt_clt_notification_event_rp0 *rp0 = (aci_gatt_eatt_clt_notification_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Attribute_Handle = Attribute_Handle;
  rp0->Attribute_Value_Length = Attribute_Value_Length;
  ...
  buffer_out[4] = 0x2e;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 2 + 2 + Attribute_Value_Length + 6, 34);
}
...
/* Event len: 2 + 2 + 1 */
/**
 * @brief This event is generated when a GATT client procedure completes on an
 *        Enhanced ATT bearer, either with error or successfully.
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @param Error_Code For standard error codes see Bluetooth specification, Vol.
 *        2, part D. For proprietary error code refer to Error codes section.
 * @retval None
 */
void aci_gatt_eatt_clt_proc_complete_event(uint16_t Connection_Handle,
                                           uint16_t CID,
                                           uint8_t Error_Code)
{
  uint8_t buffer_out[532];

  if(aci_gatt_eatt_clt_proc_complete_event_preprocess(Connection_Handle, CID, Error_Code)) return;

  /* Output params */
  aci_gatt_eatt_clt_proc_complete_event_rp0 *rp0 = (aci_gatt_eatt_clt_proc_complete_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Error_Code = Error_Code;
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 2 + 1 + 2);
  buffer_out[4] = 0x2f;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 1 + 6, 35);
}
 ...
 * @retval None
 */
void aci_gatt_eatt_clt_error_resp_event(uint16_t Connection_Handle,
                                        uint16_t CID,
                                        uint8_t Req_Opcode,
                                        uint16_t Attribute_Handle,
                                        uint8_t Error_Code)
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_gatt_eatt_clt_error_resp_event_rp0 *rp0 = (aci_gatt_eatt_clt_error_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Req_Opcode = Req_Opcode;
  rp0->Attribute_Handle = Attribute_Handle;
  ...
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 2 + 1 + 2 + 1 + 2);
  buffer_out[4] = 0x30;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 1 + 2 + 1 + 6, 36);
}

/* aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event */
/* Event len: 2 + 2 + 2 + 1 + rp0->Attribute_Value_Length * (sizeof(uint8_t)) */
/**
 * @brief This event can be generated during a "Discover Characteristics By
 *        UUID" procedure or a "Read using Characteristic UUID" procedure on an
 *        Enhanced ATT bearer. During a "Discover Characteristics By UUID"
 *        procedure, Attribute_Value is a service declaration as defined in
 *        Bluetooth Core (vol.3, Part G, ch. 3.3.1), i.e. it is composed by:
 *        Characteristic Properties (1 octet), Characteristic Value Handle (2
 *        octets) and Characteristic UUID (2 or 16 octets). During a "Read using
 *        Characteristic UUID" procedure, Attribute_Value is the value of the
 *        characteristic.
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 ...
 * @retval None
 */
void aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event(uint16_t Connection_Handle,
                                                         uint16_t CID,
                                                         uint16_t Attribute_Handle,
                                                         uint8_t Attribute_Value_Length,
                                                         uint8_t Attribute_Value[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event_rp0 *rp0 = (aci_gatt_eatt_clt_disc_read_char_by_uuid_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Attribute_Handle = Attribute_Handle;
  rp0->Attribute_Value_Length = Attribute_Value_Length;
  ...
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  HOST_TO_LE_16(buffer_out+2,2 + 2 + 2 + 1 + Attribute_Value_Length + 2);
  buffer_out[4] = 0x31;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 2 + 1 + Attribute_Value_Length + 6, 37);
}
...
/**
 * @brief This event is generated when the client has sent the confirmation to a
 *        previously sent indication on an Enhanced ATT bearer.
 * @param Connection_Handle Connection handle related to the event.
 * @param CID Local endpoint identifying the EATT channel.
 * @retval None
 */
void aci_gatt_eatt_srv_confirmation_event(uint16_t Connection_Handle,
                                          uint16_t CID)
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_gatt_eatt_srv_confirmation_event_rp0 *rp0 = (aci_gatt_eatt_srv_confirmation_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  buffer_out[0] = 0x82;
  buffer_out[1] = 0xFF;
  ...
  buffer_out[4] = 0x32;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 6, 42);
}
 ...
 *        the peer. This happens when the client wants to write a long attribute
 *        (i.e. an attribute with a size greater than ATT_MTU - 3) or more than
 *        one attribute in a single operation. The aci_gatt_eatt_srv_resp
 ...
 * @retval None
 */
void aci_eatt_srv_exec_write_req_event(uint16_t Connection_Handle,
                                       uint16_t CID,
                                       uint8_t Flags)
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_eatt_srv_exec_write_req_event_rp0 *rp0 = (aci_eatt_srv_exec_write_req_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Flags = Flags;
  buffer_out[0] = 0x82;
  ...
  buffer_out[4] = 0x33;
  buffer_out[5] = 0x0c;
  send_event(buffer_out, 2 + 2 + 1 + 6, 43);
}
...
/**
 * @brief This event is generated if authorization is needed to access the
 *        attribute value. aci_gatt_eatt_srv_authorize_resp_nwk command must be
 *        sent in response to this event.
 * @param Conn_Handle Connection handle to be used to identify the connection
 *        with the peer device.
 *        Values:
 *        - 0x0000 ... 0x0EFF
                                           ...
                                           uint8_t Data[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_gatt_eatt_srv_authorize_nwk_event_rp0 *rp0 = (aci_gatt_eatt_srv_authorize_nwk_event_rp0 *) (buffer_out + 6);
  rp0->Conn_Handle = Conn_Handle;
  rp0->CID = CID;
  rp0->Attr_Handle = Attr_Handle;
  rp0->Operation_Type = Operation_Type;
...
/**
 * @brief This event is generated in response to a Read Multiple Variable
 *        Request. See aci_gatt_eatt_clt_read_multiple_var_len_char_value().
 * @param Connection_Handle Connection handle related to the response
 * @param CID Local endpoint identifying the EATT channel.
 * @param Event_Data_Length Length of following data
 * @param Set_Of_Values A set of two or more values. A concatenation of
 ...
 * @retval None
 */
void aci_eatt_clt_read_multiple_var_len_resp_event(uint16_t Connection_Handle,
                                                   uint16_t CID,
                                                   uint16_t Event_Data_Length,
                                                   uint8_t Set_Of_Values[])
{
  uint8_t buffer_out[532];
  /* Output params */
  aci_eatt_clt_read_multiple_var_len_resp_event_rp0 *rp0 = (aci_eatt_clt_read_multiple_var_len_resp_event_rp0 *) (buffer_out + 6);
  rp0->Connection_Handle = Connection_Handle;
  rp0->CID = CID;
  rp0->Event_Data_Length = Event_Data_Length;
  Osal_MemCpy((void *) rp0->Set_Of_Values,(const void *) Set_Of_Values, Event_Data_Length);
 ...
 *        Values:
 *        - 0x0006 (7.50 ms)  ... 0x0C80 (4000.00 ms) 
 * @param Conn_Latency Peripheral latency for the connection in number of
 *        connection events.
 *        Values:
 *        - 0x0000 ... 0x01F3
...
/* Event len: 2 + 1 + 2 + 1 + 1 + 1 + 1 + 2 + 1 + struct_length */
/**
...
/* Event len: 2 + 1 + 1 + 2 + 1 + 1 + 1 + 1 + 2 + 1 + struct_length */
/**
...
/* Event len: 1 + 2 + 3 + 3 + 3 + 3 + 1 + 1 + 1 + 1 + 1 + 1 + 1 + 2 + 2 + 2 */
/**
 * @brief The HCI_LE_CIS_Established event indicates that a CIS has been
 *        established, was considered lost before being established, or (on the
 *        Central) was rejected by the Peripheral. It is generated by the
 *        Controller in the Central and Peripheral. The Connection_Handle
 *        parameter shall be set to the value provided in the HCI_LE_Create_CIS
 *        command on the Central and in the HCI_LE_CIS_Request event on the
 *        Peripheral. The CIG_Sync_Delay parameter is the maximum time, in
 *        microseconds, for transmission of PDUs of all CISes in a CIG event
 *        (see [Vol 6] Part B, Section 4.5.14.1). The CIS_Sync_Delay parameter
 *        is the maximum time, in microseconds, for transmission of PDUs of the
 *        specified CIS in a CIG event (see [Vol 6] Part B, Section 4.5.14.1).
 *        The Transport_Latency_C_To_P and Transport_Latency_P_To_C parameters
 *        are the actual transport latencies, in microseconds, as described in
 *        [Vol 6] Part G, Section 3.2.1 and [Vol 6] Part G, Section 3.2.2. The
 *        PHY_C_To_P parameter indicates the PHY selected for packets from the
 *        Central to Peripheral. The PHY_P_To_C parameter indicates the PHY
 *        selected for packets from the Peripheral to Central. The NSE,
 *        BN_C_To_P, BN_P_To_C, FT_C_To_P, FT_P_To_C, Max_PDU_- C_To_P,
 *        Max_PDU_P_To_C, and ISO_Interval parameters are the corresponding
 *        parameters of the CIS (see [Vol 6] Part B, Section 4.5.13.1). If this
 *        event is generated on the Peripheral with a non-zero status, the
 *        Controller shall delete the Connection_Handle and any associated ISO
 *        data paths.
 * @param Status For standard error codes see Bluetooth specification, Vol. 2,
 *        part D. For proprietary error code refer to Error codes section.
 ...
 *        Values:
 *        - 0x0000EA ... 0x7FFFFF
 * @param PHY_C_To_P The transmitter PHY of packets from the Central.
 *        Values:
 *        - 0x01: LE_1M_PHY
 *        - 0x02: LE_2M_PHY
 *        - 0x03: LE_CODED_PHY
 * @param PHY_P_To_C The transmitter PHY of packets from the Peripheral.
 *        Values:
 *        - 0x01: LE_1M_PHY
 *        - 0x02: LE_2M_PHY
 *        - 0x03: LE_CODED_PHY
 * @param NSE Maximum number of subevents in each isochronous event.
 *        Values:
 *        - 0x01 ... 0x1F
 * @param BN_C_To_P The burst number for Central to Peripheral transmission.
 *        Values:
 *        - 0x00: No data
 *        - 0x01 ... 0x0F
 * @param BN_P_To_C The burst number for Peripheral to Central transmission.
 *        Values:
 *        - 0x00: No data
 *        - 0x01 ... 0x0F
 * @param FT_C_To_P The flush timeout, in multiples of the ISO_Interval for the
 *        CIS, for each payload sent from the Central to the Peripheral.
 *        Values:
 *        - 0x01 ... 0xFF
 * @param FT_P_To_C The flush timeout, in multiples of the ISO_Interval for the
 *        CIS, for each payload sent from the Peripheral to the Central.
 *        Values:
 *        - 0x01 ... 0xFF
 * @param Max_PDU_C_To_P Maximum size, in octets, of the payload from Central to
 *        Peripheral.
 *        Values:
 *        - 0x0000 ... 0x00FB
 * @param Max_PDU_P_To_C Maximum size, in octets, of the payload from Peripheral
 *        to Central.
 *        Values:
 *        - 0x0000 ... 0x00FB
 * @param ISO_Interval The time between two consecutive CIS anchor points. Time
 *        = N * 1.25 ms.
 *        Values:
 *        - 0x0004 ... 0x0C80
 * @retval None
 */
void hci_le_cis_established_event(uint8_t Status,
                                  uint16_t Connection_Handle,
                                  uint8_t CIG_Sync_Delay[3],
                                  uint8_t CIS_Sync_Delay[3],
                                  uint8_t Transport_Latency_C_To_P[3],
                                  ...
                                  uint16_t ISO_Interval)
{
  uint8_t buffer_out[258];
  /* Output params */
  hci_le_cis_established_event_rp0 *rp0 = (hci_le_cis_established_event_rp0 *) (buffer_out + 4);
  rp0->Status = Status;
  rp0->Connection_Handle = Connection_Handle;
  Osal_MemCpy((void *) rp0->CIG_Sync_Delay,(const void *) CIG_Sync_Delay, 3);
  Osal_MemCpy((void *) rp0->CIS_Sync_Delay,(const void *) CIS_Sync_Delay, 3);
  Osal_MemCpy((void *) rp0->Transport_Latency_C_To_P,(const void *) Transport_Latency_C_To_P, 3);
  Osal_MemCpy((void *) rp0->Transport_Latency_P_To_C,(const void *) Transport_Latency_P_To_C, 3);
  rp0->PHY_C_To_P = PHY_C_To_P;
  rp0->PHY_P_To_C = PHY_P_To_C;
  rp0->NSE = NSE;
  rp0->BN_C_To_P = BN_C_To_P;
  rp0->BN_P_To_C = BN_P_To_C;
  rp0->FT_C_To_P = FT_C_To_P;
  rp0->FT_P_To_C = FT_P_To_C;
  rp0->Max_PDU_C_To_P = Max_PDU_C_To_P;
  rp0->Max_PDU_P_To_C = Max_PDU_P_To_C;
  rp0->ISO_Interval = ISO_Interval;
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x3E;
  buffer_out[2] = 1 + 2 + 3 + 3 + 3 + 3 + 1 + 1 + 1 + 1 + 1 + 1 + 1 + 2 + 2 + 2 + 1;
  buffer_out[3] = 0x19;
  send_event(buffer_out, buffer_out[2] + 3, -1);
}
...
/* Event len: 2 + 2 + 1 + 1 */
/**
 * @brief The HCI_LE_CIS_Request event indicates that a Controller has received
 *        a request to establish a CIS. If the Controller receives such a
 *        request while the HCI_LE_CIS_Request event is masked away, it shall
 *        reject it. Otherwise the Controller shall assign a connection handle
 *        for the requested CIS and send the handle in the CIS_Connection_Handle
 *        parameter of the event. When the Host receives this event it shall
 *        respond with either an HCI_LE_Accept_CIS_Request command or an
 *        HCI_LE_Reject_CIS_Request command before the timer
 *        Connection_Accept_Timeout expires. If it does not, the Controller
 *        shall reject the request and generate an HCI_LE_CIS_Established event
 *        with the status Connection Accept Timeout Exceeded (0x10). The
 *        ACL_Connection_Handle is the connection handle of the ACL connection
 *        that is associated with the requested CIS. The CIG_ID parameter
 *        contains the identifier of the CIG that contains the requested CIS.
 *        This parameter is sent by the Central in the request to establish the
 *        CIS. The CIS_ID parameter contains the identifier of the requested
 *        CIS. This parameter is sent by the Central in the request to establish
 *        the CIS.
 * @param ACL_Connection_Handle Connection handle of the ACL.
 *        Values:
 *        - 0x0000 ... 0x0EFF
 * @param CIS_Connection_Handle Connection handle of the CIS.
 *        Values:
 *        - 0x0000 ... 0x0EFF
 * @param CIG_ID Identifier of the CIG.
 *        Values:
 *        - 0x00 ... 0xEF
 * @param CIS_ID Identifier of the CIS.
 *        Values:
 *        - 0x00 ... 0xEF
 * @retval None
 */
void hci_le_cis_request_event(uint16_t ACL_Connection_Handle,
                              uint16_t CIS_Connection_Handle,
                              uint8_t CIG_ID,
                              uint8_t CIS_ID)
{
  uint8_t buffer_out[258];
  /* Output params */
  hci_le_cis_request_event_rp0 *rp0 = (hci_le_cis_request_event_rp0 *) (buffer_out + 4);
  rp0->ACL_Connection_Handle = ACL_Connection_Handle;
  rp0->CIS_Connection_Handle = CIS_Connection_Handle;
  rp0->CIG_ID = CIG_ID;
  rp0->CIS_ID = CIS_ID;
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x3E;
  buffer_out[2] = 2 + 2 + 1 + 1 + 1;
  buffer_out[3] = 0x1a;
  send_event(buffer_out, buffer_out[2] + 3, -1);
}

/* hci_le_create_big_complete_event */
/* Event len: 1 + 1 + 3 + 3 + 1 + 1 + 1 + 1 + 1 + 2 + 2 + 1 + struct_length */
/**
 * @brief The HCI_LE_Create_BIG_Complete event indicates that the
 *        HCI_LE_Create_BIG command has completed.
 * @param Status For standard error codes see Bluetooth specification, Vol. 2,
 *        part D. For proprietary error code refer to Error codes section.
 * @param BIG_Handle The identifier of the BIG.
 *        Values:
 *        - 0x00 ... 0xEF
 * @param BIG_Sync_Delay The maximum time in microseconds for transmission of
 *        PDUs of all BISes in a BIG event.
 *        Values:
 *        - 0x0000EA ... 0x7FFFFF
 * @param Transport_Latency_BIG The maximum delay time, in microseconds, for
 *        transmission of SDUs of all BISes in a BIG event.
 *        Values:
 *        - 0x0000EA ... 0x7FFFFF
 * @param PHY The PHY used to create the BIG.
 *        Values:
 *        - 0x01: LE_1M_PHY
 *        - 0x02: LE_2M_PHY
 *        - 0x03: LE_CODED_PHY
 * @param NSE The number of subevents in each BIS event in the BIG.
 *        Values:
 *        - 0x01 ... 0x1E
 * @param BN The number of new payloads in each BIS event.
 *        Values:
 *        - 0x01 ... 0x07
 * @param PTO Offset used for pre-transmissions.
 *        Values:
 *        - 0x00 ... 0x0F
 * @param IRC The number of times a payload is transmitted in a BIS event.
 *        Values:
 *        - 0x01 ... 0x0F
 * @param Max_PDU Maximum size, in octets, of the payload.
 *        Values:
 *        - 0x0000 ... 0x00FB
 * @param ISO_Interval The time between two consecutive BIG anchor points. Time
 *        = N * 1.25 ms.
 *        Values:
 ...
 * @retval None
 */
void hci_le_create_big_complete_event(uint8_t Status,
                                      uint8_t BIG_Handle,
                                      uint8_t BIG_Sync_Delay[3],
                                      uint8_t Transport_Latency_BIG[3],
                                      uint8_t PHY,
                                      ...
                                      Connection_Handle_t Connection_Handle[])
{
  ...
  int output_size = 0;
  /* Output params */
  hci_le_create_big_complete_event_rp0 *rp0 = (hci_le_create_big_complete_event_rp0 *) (buffer_out + 4);
  rp0->Status = Status;
  rp0->BIG_Handle = BIG_Handle;
  Osal_MemCpy((void *) rp0->BIG_Sync_Delay,(const void *) BIG_Sync_Delay, 3);
  Osal_MemCpy((void *) rp0->Transport_Latency_BIG,(const void *) Transport_Latency_BIG, 3);
  rp0->PHY = PHY;
  rp0->NSE = NSE;
  rp0->BN = BN;
  rp0->PTO = PTO;
  ...
  {
    int i;
    for (i = 0; i < rp0->Num_BIS; i++) {
      rp0->Connection_Handle[i].Connection_Handle = Connection_Handle[i].Connection_Handle;
      output_size += sizeof(uint16_t);
    }
  }
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x3E;
  buffer_out[2] = 1 + 1 + 3 + 3 + 1 + 1 + 1 + 1 + 1 + 2 + 2 + 1 + output_size + 1;
  buffer_out[3] = 0x1b;
  send_event(buffer_out, buffer_out[2] + 3, -1);
}
...
/* Event len: 1 + 1 */
/**
 * @brief The HCI_LE_Terminate_BIG_Complete event indicates that the
 *        transmission of all the BISes in the BIG are terminated.
 * @param BIG_Handle The identifier of the BIG.
 *        Values:
 *        - 0x00 ... 0xEF
 ...
 * @retval None
 */
void hci_le_terminate_big_complete_event(uint8_t BIG_Handle,
                                         uint8_t Reason)
{
  uint8_t buffer_out[258];
  /* Output params */
  hci_le_terminate_big_complete_event_rp0 *rp0 = (hci_le_terminate_big_complete_event_rp0 *) (buffer_out + 4);
  rp0->BIG_Handle = BIG_Handle;
  rp0->Reason = Reason;
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x3E;
...
/* Event len: 1 + 1 + 3 + 1 + 1 + 1 + 1 + 2 + 2 + 1 + struct_length */
/**
 * @brief The HCI_LE_BIG_Sync_Established event indicates that the
 ...
 * @retval None
 */
void hci_le_big_sync_established_event(uint8_t Status,
                                       uint8_t BIG_Handle,
                                       uint8_t Transport_Latency_BIG[3],
                                       uint8_t NSE,
                                       uint8_t BN,
                                       ...
                                       Connection_Handle_t Connection_Handle[])
{
  ...
  int output_size = 0;
  /* Output params */
  hci_le_big_sync_established_event_rp0 *rp0 = (hci_le_big_sync_established_event_rp0 *) (buffer_out + 4);
  rp0->Status = Status;
  rp0->BIG_Handle = BIG_Handle;
  Osal_MemCpy((void *) rp0->Transport_Latency_BIG,(const void *) Transport_Latency_BIG, 3);
  rp0->NSE = NSE;
  ...
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x3E;
  buffer_out[2] = 1 + 1 + 3 + 1 + 1 + 1 + 1 + 2 + 2 + 1 + output_size + 1;
  buffer_out[3] = 0x1d;
  send_event(buffer_out, buffer_out[2] + 3, -1);
}
...
/* Event len: 1 + 1 */
/**
 * @brief The HCI_LE_BIG_Sync_Lost event indicates that the Controller has not
 ...
 * @retval None
 */
void hci_le_big_sync_lost_event(uint8_t BIG_Handle,
                                uint8_t Reason)
{
  uint8_t buffer_out[258];
  /* Output params */
  hci_le_big_sync_lost_event_rp0 *rp0 = (hci_le_big_sync_lost_event_rp0 *) (buffer_out + 4);
  rp0->BIG_Handle = BIG_Handle;
  rp0->Reason = Reason;
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x3E;
...
/* Event len: 1 + 2 + 1 */
/**
 * @brief The HCI_LE_Request_Peer_SCA_Complete event indicates that the
 *        HCI_LE_Request_Peer_SCA command has been completed. The
 *        Peer_Clock_Accuracy parameter contains the sleep clock accuracy of the
 *        peer. The Connection_Handle is the connection handle of the ACL
 *        connection in which the HCI_LE_Request_Peer_SCA command is issued.
 * @param Status For standard error codes see Bluetooth specification, Vol. 2,
 *        part D. For proprietary error code refer to Error codes section.
 ...
 * @retval None
 */
void hci_le_request_peer_sca_complete_event(uint8_t Status,
                                            uint16_t Connection_Handle,
                                            uint8_t Peer_Clock_Accuracy)
{
  uint8_t buffer_out[258];
  /* Output params */
  hci_le_request_peer_sca_complete_event_rp0 *rp0 = (hci_le_request_peer_sca_complete_event_rp0 *) (buffer_out + 4);
  rp0->Status = Status;
  rp0->Connection_Handle = Connection_Handle;
  rp0->Peer_Clock_Accuracy = Peer_Clock_Accuracy;
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x3E;
  buffer_out[2] = 1 + 2 + 1 + 1;
  buffer_out[3] = 0x1f;
  send_event(buffer_out, buffer_out[2] + 3, -1);
}
...
/* Event len: 2 + 1 + 1 + 2 + 1 + 1 + 1 + 2 + 3 + 2 + 1 + 1 + 1 */
/**
 * @brief The HCI_LE_BIG_Sync_Established event indicates that the
 *        HCI_LE_BIG_Create_Sync command has completed.
 * @param Sync_Handle Sync_Handle identifying the periodic advertising train.
 *        Values:
 *        - 0x0000 ... 0x0EFF
 * @param Num_BIS Value of the Num_BIS subfield of the BIGInfo field.
 *        Values:
 *        - 0x01 ... 0x1F
 * @param NSE Value of the NSE subfield of the BIGInfo field.
 * @param ISO_Interval Value of the ISO_Interval subfield of the BIGInfo field.
 * @param BN Value of the BN subfield of the BIGInfo field.
 *        Values:
 *        - 0x01 ... 0x07
 * @param PTO Value of the PTO subfield of the BIGInfo field.
 *        Values:
 *        - 0x00 ... 0x0F
 * @param IRC Value of the IRC subfield of the BIGInfo field.
 *        Values:
 *        - 0x01 ... 0x0F
 * @param Max_PDU Value of the Max_PDU subfield of the BIGInfo.
 *        Values:
 *        - 0x0000 ... 0x00FB
 * @param SDU_Interval Value of the SDU_Interval subfield of the BIGInfo field.
 *        Values:
 *        - 0x0000FF ... 0x0FFFFF
 * @param Max_SDU Value of the Max_SDU subfield of the BIGInfo field in the
 *        Advertising PDU.
 *        Values:
 *        - 0x0001 ... 0x0FFF
 * @param PHY The PHY on which the BIG is transmitted.
 *        Values:
 *        - 0x01: LE_1M_PHY
 *        - 0x02: LE_2M_PHY
 *        - 0x03: LE_CODED_PHY
 * @param Framing If BIG carries encrypted (1) or unencrypted (0) data.
 *        Values:
 *        - 0x00: Unencrypted
 *        - 0x01: Encrypted
 * @param Encryption If BIG carries encrypted (1) or unencrypted (0) data.
 *        Values:
 *        - 0x00: Unencrypted
 *        - 0x01: Encrypted
 * @retval None
 */
void hci_le_biginfo_advertising_report_event(uint16_t Sync_Handle,
                                             uint8_t Num_BIS,
                                             uint8_t NSE,
                                             uint16_t ISO_Interval,
                                             uint8_t BN,
                                             ...
                                             uint8_t Encryption)
{
  uint8_t buffer_out[258];
  /* Output params */
  hci_le_biginfo_advertising_report_event_rp0 *rp0 = (hci_le_biginfo_advertising_report_event_rp0 *) (buffer_out + 4);
  rp0->Sync_Handle = Sync_Handle;
  rp0->Num_BIS = Num_BIS;
  rp0->NSE = NSE;
  rp0->ISO_Interval = ISO_Interval;
  ...
  rp0->IRC = IRC;
  rp0->Max_PDU = Max_PDU;
  Osal_MemCpy((void *) rp0->SDU_Interval,(const void *) SDU_Interval, 3);
  rp0->Max_SDU = Max_SDU;
  rp0->PHY = PHY;
  rp0->Framing = Framing;
  rp0->Encryption = Encryption;
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x3E;
  buffer_out[2] = 2 + 1 + 1 + 2 + 1 + 1 + 1 + 2 + 3 + 2 + 1 + 1 + 1 + 1;
  buffer_out[3] = 0x22;
  send_event(buffer_out, buffer_out[2] + 3, -1);
}

/* hci_le_subrate_change_event */
/* Event len: 1 + 2 + 2 + 2 + 2 + 2 */
/**
 * @brief The HCI_LE_Subrate_Change event is used to indicate that a Connection
 *        Subrate Update procedure has completed and some parameters of the
 *        specified connection have changed. This event shall be issued if the
 *        HCI_LE_Subrate_Request command was issued by the Host or the
 *        parameters are updated successfully following a request from the peer
 *        device. If no parameters are updated following a request from the peer
 *        device or the parameters were changed using the Connection Update
 *        procedure, then this event shall not be issued.
 * @param Status For standard error codes see Bluetooth specification, Vol. 2,
 *        part D. For proprietary error code refer to Error codes section.
 * @param Connection_Handle Handle identifing the connection.
 *        Values:
 *        - 0x0000 ... 0x0EFF
 ...
 *        Values:
 *        - 0x0001 ... 0x01F4
 * @param Peripheral_Latency New Peripheral latency for the connection in number
 *        of subrated connection events,
 *        Values:
 *        - 0x0000 ... 0x01F3
 * @param Continuation_Number Number of underlying connection events to remain
 *        active after a packet containing a Link Layer PDU with a non-zero
 *        Length field is sent or received.
 *        Values:
 *        - 0x0000 ... 0x01F3
 * @param Supervision_Timeout New supervision timeout for this connection. Time
 *        = N x 10 ms.
 *        Values:
 *        - 0x000A (100 ms)  ... 0x0C80 (32000 ms) 
 * @retval None
 */
void hci_le_subrate_change_event(uint8_t Status,
                                 uint16_t Connection_Handle,
                                 uint16_t Subrate_Factor,
                                 uint16_t Peripheral_Latency,
                                 uint16_t Continuation_Number,
                                 uint16_t Supervision_Timeout)
{
  uint8_t buffer_out[258];
  /* Output params */
  hci_le_subrate_change_event_rp0 *rp0 = (hci_le_subrate_change_event_rp0 *) (buffer_out + 4);
  rp0->Status = Status;
  rp0->Connection_Handle = Connection_Handle;
  rp0->Subrate_Factor = Subrate_Factor;
  rp0->Peripheral_Latency = Peripheral_Latency;
  rp0->Continuation_Number = Continuation_Number;
  rp0->Supervision_Timeout = Supervision_Timeout;
  buffer_out[0] = 0x04;
  buffer_out[1] = 0x3E;
  buffer_out[2] = 1 + 2 + 2 + 2 + 2 + 2 + 1;
  buffer_out[3] = 0x23;
  send_event(buffer_out, buffer_out[2] + 3, -1);
}

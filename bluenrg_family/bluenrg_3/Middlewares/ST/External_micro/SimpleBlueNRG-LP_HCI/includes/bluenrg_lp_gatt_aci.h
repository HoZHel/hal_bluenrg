...
tBleStatus aci_gatt_srv_notify(uint16_t Connection_Handle,
                               ...
                               uint8_t Val[]);
/**
 * @brief Response to an @ref aci_att_srv_exec_write_req_event.
 ...
 * @brief Starts the procedure to write an attribute (characteristic value or
 *        descriptor). When the procedure is completed, a @ref
 *        aci_gatt_eatt_clt_proc_complete_event event is generated.
 * @param Connection_Handle Connection handle that identifies the connection.
 *        Values:
 *        - 0x0000 ... 0x0EFF
 * @param CID Local endpoint identifying the EATT channel.
 ...
 *        event is generated. During the procedure, @ref
 *        aci_eatt_clt_prepare_write_resp_event and @ref
 *        aci_eatt_clt_exec_write_resp_event events are raised.
 * @param Connection_Handle Connection handle that identifies the connection.
 *        Values:
 *        - 0x0000 ... 0x0EFF
 * @param CID Local endpoint identifying the EATT channel.
...
tBleStatus aci_gatt_eatt_srv_notify(uint16_t Connection_Handle,
                                    ...
                                    uint8_t Val[]);
/**
 * @brief Response to an @ref aci_eatt_srv_exec_write_req_event.
 * @param Conn_Handle Connection handle that identifies the connection.
 *        Values:
 *        - 0x0000 ... 0x0EFF
 * @param CID Local endpoint identifying the EATT channel.
...
tBleStatus aci_gatt_eatt_srv_exec_write_resp_nwk(uint16_t Conn_Handle,
                                                 ...
                                                 uint8_t Exec);
/**
 * @brief This command should be sent when @ref
 *        aci_gatt_eatt_srv_authorize_nwk_event is received.
 * @param Conn_Handle Connection handle to be used to identify the connection
 *        with the peer device.
 *        Values:
 *        - 0x0000 ... 0x0EFF
